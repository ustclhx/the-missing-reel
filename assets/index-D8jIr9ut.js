(function(){const A=document.createElement("link").relList;if(A&&A.supports&&A.supports("modulepreload"))return;for(const z of document.querySelectorAll('link[rel="modulepreload"]'))f(z);new MutationObserver(z=>{for(const C of z)if(C.type==="childList")for(const T of C.addedNodes)T.tagName==="LINK"&&T.rel==="modulepreload"&&f(T)}).observe(document,{childList:!0,subtree:!0});function E(z){const C={};return z.integrity&&(C.integrity=z.integrity),z.referrerPolicy&&(C.referrerPolicy=z.referrerPolicy),z.crossOrigin==="use-credentials"?C.credentials="include":z.crossOrigin==="anonymous"?C.credentials="omit":C.credentials="same-origin",C}function f(z){if(z.ep)return;z.ep=!0;const C=E(z);fetch(z.href,C)}})();function Yh(m){return m&&m.__esModule&&Object.prototype.hasOwnProperty.call(m,"default")?m.default:m}var br={exports:{}},Ol={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Th;function vp(){if(Th)return F;Th=1;var m=Symbol.for("react.transitional.element"),A=Symbol.for("react.portal"),E=Symbol.for("react.fragment"),f=Symbol.for("react.strict_mode"),z=Symbol.for("react.profiler"),C=Symbol.for("react.consumer"),T=Symbol.for("react.context"),q=Symbol.for("react.forward_ref"),I=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),V=Symbol.for("react.lazy"),R=Symbol.for("react.activity"),W=Symbol.iterator;function Le(d){return d===null||typeof d!="object"?null:(d=W&&d[W]||d["@@iterator"],typeof d=="function"?d:null)}var ke={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ze=Object.assign,Je={};function Me(d,u,N){this.props=d,this.context=u,this.refs=Je,this.updater=N||ke}Me.prototype.isReactComponent={},Me.prototype.setState=function(d,u){if(typeof d!="object"&&typeof d!="function"&&d!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,d,u,"setState")},Me.prototype.forceUpdate=function(d){this.updater.enqueueForceUpdate(this,d,"forceUpdate")};function le(){}le.prototype=Me.prototype;function P(d,u,N){this.props=d,this.context=u,this.refs=Je,this.updater=N||ke}var me=P.prototype=new le;me.constructor=P,ze(me,Me.prototype),me.isPureReactComponent=!0;var xe=Array.isArray;function we(){}var K={H:null,A:null,T:null,S:null},ne=Object.prototype.hasOwnProperty;function _e(d,u,N){var O=N.ref;return{$$typeof:m,type:d,key:u,ref:O!==void 0?O:null,props:N}}function st(d,u){return _e(d.type,u,d.props)}function Ne(d){return typeof d=="object"&&d!==null&&d.$$typeof===m}function Be(d){var u={"=":"=0",":":"=2"};return"$"+d.replace(/[=:]/g,function(N){return u[N]})}var Oe=/\/+/g;function ue(d,u){return typeof d=="object"&&d!==null&&d.key!=null?Be(""+d.key):u.toString(36)}function De(d){switch(d.status){case"fulfilled":return d.value;case"rejected":throw d.reason;default:switch(typeof d.status=="string"?d.then(we,we):(d.status="pending",d.then(function(u){d.status==="pending"&&(d.status="fulfilled",d.value=u)},function(u){d.status==="pending"&&(d.status="rejected",d.reason=u)})),d.status){case"fulfilled":return d.value;case"rejected":throw d.reason}}throw d}function _(d,u,N,O,L){var U=typeof d;(U==="undefined"||U==="boolean")&&(d=null);var J=!1;if(d===null)J=!0;else switch(U){case"bigint":case"string":case"number":J=!0;break;case"object":switch(d.$$typeof){case m:case A:J=!0;break;case V:return J=d._init,_(J(d._payload),u,N,O,L)}}if(J)return L=L(d),J=O===""?"."+ue(d,0):O,xe(L)?(N="",J!=null&&(N=J.replace(Oe,"$&/")+"/"),_(L,u,N,"",function(X){return X})):L!=null&&(Ne(L)&&(L=st(L,N+(L.key==null||d&&d.key===L.key?"":(""+L.key).replace(Oe,"$&/")+"/")+J)),u.push(L)),1;J=0;var ce=O===""?".":O+":";if(xe(d))for(var j=0;j<d.length;j++)O=d[j],U=ce+ue(O,j),J+=_(O,u,N,U,L);else if(j=Le(d),typeof j=="function")for(d=j.call(d),j=0;!(O=d.next()).done;)O=O.value,U=ce+ue(O,j++),J+=_(O,u,N,U,L);else if(U==="object"){if(typeof d.then=="function")return _(De(d),u,N,O,L);throw u=String(d),Error("Objects are not valid as a React child (found: "+(u==="[object Object]"?"object with keys {"+Object.keys(d).join(", ")+"}":u)+"). If you meant to render a collection of children, use an array instead.")}return J}function D(d,u,N){if(d==null)return d;var O=[],L=0;return _(d,O,"","",function(U){return u.call(N,U,L++)}),O}function G(d){if(d._status===-1){var u=d._result;u=u(),u.then(function(N){(d._status===0||d._status===-1)&&(d._status=1,d._result=N)},function(N){(d._status===0||d._status===-1)&&(d._status=2,d._result=N)}),d._status===-1&&(d._status=0,d._result=u)}if(d._status===1)return d._result.default;throw d._result}var ie=typeof reportError=="function"?reportError:function(d){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var u=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof d=="object"&&d!==null&&typeof d.message=="string"?String(d.message):String(d),error:d});if(!window.dispatchEvent(u))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",d);return}console.error(d)},ye={map:D,forEach:function(d,u,N){D(d,function(){u.apply(this,arguments)},N)},count:function(d){var u=0;return D(d,function(){u++}),u},toArray:function(d){return D(d,function(u){return u})||[]},only:function(d){if(!Ne(d))throw Error("React.Children.only expected to receive a single React element child.");return d}};return F.Activity=R,F.Children=ye,F.Component=Me,F.Fragment=E,F.Profiler=z,F.PureComponent=P,F.StrictMode=f,F.Suspense=I,F.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=K,F.__COMPILER_RUNTIME={__proto__:null,c:function(d){return K.H.useMemoCache(d)}},F.cache=function(d){return function(){return d.apply(null,arguments)}},F.cacheSignal=function(){return null},F.cloneElement=function(d,u,N){if(d==null)throw Error("The argument must be a React element, but you passed "+d+".");var O=ze({},d.props),L=d.key;if(u!=null)for(U in u.key!==void 0&&(L=""+u.key),u)!ne.call(u,U)||U==="key"||U==="__self"||U==="__source"||U==="ref"&&u.ref===void 0||(O[U]=u[U]);var U=arguments.length-2;if(U===1)O.children=N;else if(1<U){for(var J=Array(U),ce=0;ce<U;ce++)J[ce]=arguments[ce+2];O.children=J}return _e(d.type,L,O)},F.createContext=function(d){return d={$$typeof:T,_currentValue:d,_currentValue2:d,_threadCount:0,Provider:null,Consumer:null},d.Provider=d,d.Consumer={$$typeof:C,_context:d},d},F.createElement=function(d,u,N){var O,L={},U=null;if(u!=null)for(O in u.key!==void 0&&(U=""+u.key),u)ne.call(u,O)&&O!=="key"&&O!=="__self"&&O!=="__source"&&(L[O]=u[O]);var J=arguments.length-2;if(J===1)L.children=N;else if(1<J){for(var ce=Array(J),j=0;j<J;j++)ce[j]=arguments[j+2];L.children=ce}if(d&&d.defaultProps)for(O in J=d.defaultProps,J)L[O]===void 0&&(L[O]=J[O]);return _e(d,U,L)},F.createRef=function(){return{current:null}},F.forwardRef=function(d){return{$$typeof:q,render:d}},F.isValidElement=Ne,F.lazy=function(d){return{$$typeof:V,_payload:{_status:-1,_result:d},_init:G}},F.memo=function(d,u){return{$$typeof:x,type:d,compare:u===void 0?null:u}},F.startTransition=function(d){var u=K.T,N={};K.T=N;try{var O=d(),L=K.S;L!==null&&L(N,O),typeof O=="object"&&O!==null&&typeof O.then=="function"&&O.then(we,ie)}catch(U){ie(U)}finally{u!==null&&N.types!==null&&(u.types=N.types),K.T=u}},F.unstable_useCacheRefresh=function(){return K.H.useCacheRefresh()},F.use=function(d){return K.H.use(d)},F.useActionState=function(d,u,N){return K.H.useActionState(d,u,N)},F.useCallback=function(d,u){return K.H.useCallback(d,u)},F.useContext=function(d){return K.H.useContext(d)},F.useDebugValue=function(){},F.useDeferredValue=function(d,u){return K.H.useDeferredValue(d,u)},F.useEffect=function(d,u){return K.H.useEffect(d,u)},F.useEffectEvent=function(d){return K.H.useEffectEvent(d)},F.useId=function(){return K.H.useId()},F.useImperativeHandle=function(d,u,N){return K.H.useImperativeHandle(d,u,N)},F.useInsertionEffect=function(d,u){return K.H.useInsertionEffect(d,u)},F.useLayoutEffect=function(d,u){return K.H.useLayoutEffect(d,u)},F.useMemo=function(d,u){return K.H.useMemo(d,u)},F.useOptimistic=function(d,u){return K.H.useOptimistic(d,u)},F.useReducer=function(d,u,N){return K.H.useReducer(d,u,N)},F.useRef=function(d){return K.H.useRef(d)},F.useState=function(d){return K.H.useState(d)},F.useSyncExternalStore=function(d,u,N){return K.H.useSyncExternalStore(d,u,N)},F.useTransition=function(){return K.H.useTransition()},F.version="19.2.3",F}var Eh;function Nr(){return Eh||(Eh=1,vr.exports=vp()),vr.exports}var M=Nr();const _p=Yh(M);var _r={exports:{}},Dl={},xr={exports:{}},wr={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zh;function xp(){return zh||(zh=1,(function(m){function A(_,D){var G=_.length;_.push(D);e:for(;0<G;){var ie=G-1>>>1,ye=_[ie];if(0<z(ye,D))_[ie]=D,_[G]=ye,G=ie;else break e}}function E(_){return _.length===0?null:_[0]}function f(_){if(_.length===0)return null;var D=_[0],G=_.pop();if(G!==D){_[0]=G;e:for(var ie=0,ye=_.length,d=ye>>>1;ie<d;){var u=2*(ie+1)-1,N=_[u],O=u+1,L=_[O];if(0>z(N,G))O<ye&&0>z(L,N)?(_[ie]=L,_[O]=G,ie=O):(_[ie]=N,_[u]=G,ie=u);else if(O<ye&&0>z(L,G))_[ie]=L,_[O]=G,ie=O;else break e}}return D}function z(_,D){var G=_.sortIndex-D.sortIndex;return G!==0?G:_.id-D.id}if(m.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var C=performance;m.unstable_now=function(){return C.now()}}else{var T=Date,q=T.now();m.unstable_now=function(){return T.now()-q}}var I=[],x=[],V=1,R=null,W=3,Le=!1,ke=!1,ze=!1,Je=!1,Me=typeof setTimeout=="function"?setTimeout:null,le=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function me(_){for(var D=E(x);D!==null;){if(D.callback===null)f(x);else if(D.startTime<=_)f(x),D.sortIndex=D.expirationTime,A(I,D);else break;D=E(x)}}function xe(_){if(ze=!1,me(_),!ke)if(E(I)!==null)ke=!0,we||(we=!0,Be());else{var D=E(x);D!==null&&De(xe,D.startTime-_)}}var we=!1,K=-1,ne=5,_e=-1;function st(){return Je?!0:!(m.unstable_now()-_e<ne)}function Ne(){if(Je=!1,we){var _=m.unstable_now();_e=_;var D=!0;try{e:{ke=!1,ze&&(ze=!1,le(K),K=-1),Le=!0;var G=W;try{t:{for(me(_),R=E(I);R!==null&&!(R.expirationTime>_&&st());){var ie=R.callback;if(typeof ie=="function"){R.callback=null,W=R.priorityLevel;var ye=ie(R.expirationTime<=_);if(_=m.unstable_now(),typeof ye=="function"){R.callback=ye,me(_),D=!0;break t}R===E(I)&&f(I),me(_)}else f(I);R=E(I)}if(R!==null)D=!0;else{var d=E(x);d!==null&&De(xe,d.startTime-_),D=!1}}break e}finally{R=null,W=G,Le=!1}D=void 0}}finally{D?Be():we=!1}}}var Be;if(typeof P=="function")Be=function(){P(Ne)};else if(typeof MessageChannel<"u"){var Oe=new MessageChannel,ue=Oe.port2;Oe.port1.onmessage=Ne,Be=function(){ue.postMessage(null)}}else Be=function(){Me(Ne,0)};function De(_,D){K=Me(function(){_(m.unstable_now())},D)}m.unstable_IdlePriority=5,m.unstable_ImmediatePriority=1,m.unstable_LowPriority=4,m.unstable_NormalPriority=3,m.unstable_Profiling=null,m.unstable_UserBlockingPriority=2,m.unstable_cancelCallback=function(_){_.callback=null},m.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ne=0<_?Math.floor(1e3/_):5},m.unstable_getCurrentPriorityLevel=function(){return W},m.unstable_next=function(_){switch(W){case 1:case 2:case 3:var D=3;break;default:D=W}var G=W;W=D;try{return _()}finally{W=G}},m.unstable_requestPaint=function(){Je=!0},m.unstable_runWithPriority=function(_,D){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var G=W;W=_;try{return D()}finally{W=G}},m.unstable_scheduleCallback=function(_,D,G){var ie=m.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?ie+G:ie):G=ie,_){case 1:var ye=-1;break;case 2:ye=250;break;case 5:ye=1073741823;break;case 4:ye=1e4;break;default:ye=5e3}return ye=G+ye,_={id:V++,callback:D,priorityLevel:_,startTime:G,expirationTime:ye,sortIndex:-1},G>ie?(_.sortIndex=G,A(x,_),E(I)===null&&_===E(x)&&(ze?(le(K),K=-1):ze=!0,De(xe,G-ie))):(_.sortIndex=ye,A(I,_),ke||Le||(ke=!0,we||(we=!0,Be()))),_},m.unstable_shouldYield=st,m.unstable_wrapCallback=function(_){var D=W;return function(){var G=W;W=D;try{return _.apply(this,arguments)}finally{W=G}}}})(wr)),wr}var Mh;function wp(){return Mh||(Mh=1,xr.exports=xp()),xr.exports}var Sr={exports:{}},rt={};/**
 * @license React
...
`).map(ee=>ee.trim()).filter(ee=>ee.length>0).map((ee,oe)=>{if(ee.startsWith("（")||ee.startsWith("("))return{id:oe,speaker:null,text:ee,type:"direction"};const Ie=ee.match(/^([^：:]+)[：:](.+)$/);return Ie?{id:oe,speaker:Ie[1].trim(),text:Ie[2].trim(),type:"dialogue"}:{id:oe,speaker:null,text:ee,type:"direction"}}),ye=()=>{const j=x.trim(),X=R.trim();if(!j||!X){ke("请输入完整的姓名和日期。");return}const ee=`${j}_${X}`.toLowerCase(),oe=Ar.find(Ie=>Ie.searchId.toLowerCase()===ee);oe?A.includes(oe.id)?(ke("该录音已存在于列表中。"),d(oe)):(E(oe.id),ke("检索成功。加载中..."),setTimeout(()=>{d(oe),V(""),W("")},1e3)):ke("错误：未找到对应编号的录音。")},d=j=>{G.current&&clearTimeout(G.current);const X=ie(j.content);if(Je(X),le(0),I(j),X.length>0&&X[0].type==="direction"){const oe=X[0].text.split(/([，。；！])/).reduce((We,Vt,Ca)=>(Vt.match(/[，。；！]/)&&Ca>0?We[We.length-1]+=Vt:Vt.trim()&&We.push(Vt),We),[]);Oe(oe),De(0),D(!1);const Ie=oe.join("").length;let tt=0;const $e=()=>{if(tt++,De(tt),tt<Ie){const We=Math.random()*30+30;G.current=setTimeout($e,We)}else setTimeout(()=>{D(!0),T==null||T()},500)};$e()}else Oe([]),D(!0),T==null||T()};M.useEffect(()=>()=>{G.current&&clearTimeout(G.current)},[]),M.useEffect(()=>{if(f)return;const j=Ar.find(X=>X.isAutoPlay);j&&A.includes(j.id)&&(z(!0),setTimeout(()=>{d(j)},500))},[f,A,z]);const u=M.useMemo(()=>{const j=Me*kr;return ze.slice(j,j+kr)},[ze,Me]),N=Math.ceil(ze.length/kr),O=(j,X)=>ze.find((oe,Ie)=>Ie<j&&oe.speaker===X)?null:X,L=j=>j.split(/__([^_]+)__/g).map((ee,oe)=>oe%2===1?o.jsx("span",{className:"text-red-400 border-b border-red-500/40 pb-0.5 mx-1 font-bold tracking-wider",children:ee},oe):o.jsx("span",{children:ee},oe)),U=j=>j.includes("陌生人1")||j.includes("Stranger 1")?"text-red-600 font-bold":j.includes("苹果")||j.includes("Apple")?"text-stone-400":"text-amber-700",J=j=>j.includes("陌生人1")||j.includes("Stranger 1")?"text-red-500/90 border-red-900/50 glitch-text":j.includes("苹果")||j.includes("Apple")?"text-stone-200 border-stone-600":"text-amber-500/90 border-amber-900/50",{language:ce}=en();return o.jsxs("div",{className:"flex-1 flex flex-col bg-stone-900 relative",children:[o.jsxs("div",{className:"h-14 sm:h-16 border-b border-stone-800 flex items-center justify-between px-3 sm:px-6 bg-stone-900 shadow-md z-10",children:[o.jsx("button",{onClick:m,className:"text-stone-400 hover:text-white text-[10px] sm:text-xs font-mono tracking-widest uppercase shrink-0",children:"[ OFF ]"}),o.jsxs("div",{className:"flex items-center gap-2 sm:gap-4 flex-1 justify-end",children:[o.jsx("span",{className:"text-[10px] text-stone-400 uppercase tracking-widest hidden lg:inline",children:"Tape Index:"}),o.jsxs("div",{className:"flex bg-stone-800/80 border border-stone-700 rounded-sm overflow-hidden group focus-within:border-stone-500 transition-colors items-center",children:[o.jsx("input",{type:"text",value:x,onChange:j=>V(j.target.value),placeholder:"姓名",className:"bg-transparent text-stone-100 px-1.5 sm:px-2 py-1 text-xs sm:text-sm focus:outline-none w-14 sm:w-20 text-center font-serif-film placeholder-stone-600"}),o.jsx("span",{className:"text-stone-400 font-mono select-none text-xs",children:"_"}),o.jsx("input",{type:"text",value:R,onChange:j=>W(j.target.value),placeholder:"日期",className:"bg-transparent text-stone-100 px-1.5 sm:px-2 py-1 text-xs sm:text-sm focus:outline-none w-16 sm:w-24 text-center font-serif-film placeholder-stone-600"}),o.jsx("button",{onClick:ye,className:"text-stone-300 bg-stone-700 px-2 sm:px-3 py-1 text-[10px] sm:text-xs border-l border-stone-600 hover:bg-stone-600 hover:text-white transition-colors h-full",children:"PLAY"})]})]})]}),o.jsxs("div",{className:"flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden relative",children:[o.jsxs("div",{className:`
        ...
        `,children:[o.jsx("div",{className:"p-4 border-b border-stone-800 text-[10px] text-stone-400 font-mono text-center tracking-widest",children:"ARCHIVED RECORDINGS"}),o.jsxs("div",{className:"flex-1 overflow-y-auto p-2 space-y-2 scrollbar-hide",children:[Le!=="等待输入..."&&o.jsx("div",{className:"text-xs text-amber-500 p-2 font-mono text-center animate-pulse",children:Le}),Ne.map(j=>{const X=(q==null?void 0:q.id)===j.id;return o.jsxs("button",{onClick:()=>d(j),className:`
                            ...
                            `,children:[o.jsxs("div",{className:"flex items-baseline justify-between relative z-10",children:[o.jsx("span",{className:`font-mono text-xs ${X?"text-amber-500":"text-stone-600 group-hover:text-stone-500"}`,children:X?"● PLAYING":"○ READY"}),X&&o.jsxs("span",{className:"text-[10px] animate-pulse",children:["00:0",Math.floor(Math.random()*9),"..."]})]}),o.jsx("div",{className:"mt-2 font-serif-film text-sm tracking-wide truncate relative z-10",children:j.title})]},j.id)})]}),st>1&&o.jsxs("div",{className:"p-2 border-t border-stone-800 flex justify-between items-center bg-stone-900",children:[o.jsx("button",{onClick:()=>K(j=>Math.max(0,j-1)),disabled:we===0,className:"text-stone-500 hover:text-stone-300 disabled:opacity-30 disabled:hover:text-stone-500 px-2 py-1 text-xs font-mono",children:"< PREV"}),o.jsxs("span",{className:"text-[10px] text-stone-600 font-mono",children:["PG ",we+1,"/",st]}),o.jsx("button",{onClick:()=>K(j=>Math.min(st-1,j+1)),disabled:we===st-1,className:"text-stone-500 hover:text-stone-300 disabled:opacity-30 disabled:hover:text-stone-500 px-2 py-1 text-xs font-mono",children:"NEXT >"})]})]}),o.jsxs("div",{className:"flex-1 bg-black relative flex flex-col items-center justify-center p-6 overflow-y-auto",children:[o.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(30,30,30,1)_0%,rgba(0,0,0,1)_100%)]"}),q?o.jsxs(o.Fragment,{children:[_&&N>1&&o.jsxs(o.Fragment,{children:[o.jsx("button",{onClick:()=>le(j=>Math.max(0,j-1)),disabled:Me===0,className:"absolute left-0 top-1/2 -translate-y-1/2 z-50 p-3 md:p-4 text-stone-600 hover:text-stone-300 disabled:opacity-0 transition-all opacity-50 hover:opacity-100",children:o.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:2,stroke:"currentColor",className:"w-6 h-6 md:w-8 md:h-8",children:o.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.75 19.5L8.25 12l7.5-7.5"})})}),o.jsx("button",{onClick:()=>{Me===N-1?(q==null?void 0:q.id)==="awen_20231103"&&(C==null||C()):le(j=>j+1)},disabled:Me===N-1&&(q==null?void 0:q.id)!=="awen_20231103",className:"absolute right-0 top-1/2 -translate-y-1/2 z-50 p-3 md:p-4 text-stone-600 hover:text-stone-300 disabled:opacity-0 transition-all opacity-50 hover:opacity-100",children:o.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:2,stroke:"currentColor",className:"w-6 h-6 md:w-8 md:h-8",children:o.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M8.25 4.5l7.5 7.5-7.5 7.5"})})}),o.jsx("div",{className:"absolute bottom-6 left-0 right-0 flex justify-center gap-3 z-50",children:Array.from({length:N}).map((j,X)=>o.jsx("div",{className:`rounded-full transition-all duration-300 ${X===Me?"w-2 h-2 bg-[#DA291C] shadow-[0_0_8px_rgba(218,41,28,0.6)]":"w-1.5 h-1.5 bg-stone-800"}`},X))})]}),o.jsxs("div",{className:"w-full max-w-2xl relative z-10 flex flex-col h-full max-h-[70vh] sm:max-h-[600px] mb-8 sm:mb-12 px-4 sm:px-8 md:px-16",children:[o.jsx("div",{className:"text-center mb-8 opacity-70",children:o.jsxs("h2",{className:"text-stone-500 text-xs font-mono tracking-[0.5em] uppercase border-b border-stone-800 pb-2 inline-block",children:[q.title," // PAGE ",Me+1]})}),o.jsx("div",{className:"flex-1 flex flex-col justify-center space-y-8 min-h-[300px]",children:u.map(j=>{const X=j.id===0;return!_&&!X?null:o.jsx("div",{className:"w-full animate-in fade-in slide-in-from-bottom-2 duration-700 fill-mode-both",children:j.type==="direction"?o.jsx("div",{className:"text-center flex flex-col gap-2 items-center",children:X&&!_?o.jsx("div",{className:"space-y-2",children:(()=>{let oe=0;return Be.map((Ie,tt)=>{const $e=oe,We=$e+Ie.length;if(oe+=Ie.length,ue<=$e)return null;const Vt=Math.min(Ie.length,ue-$e),Ca=Ie.slice(0,Vt);return o.jsxs("p",{className:"text-stone-600 italic font-serif-film text-sm md:text-base leading-relaxed tracking-wider px-8",children:[L(Ca),ue>$e&&ue<We&&o.jsx("span",{className:"inline-block w-2 h-4 bg-stone-500 ml-1 animate-pulse align-middle"})]},tt)})})()}):o.jsx("p",{className:`
                                                    text-stone-600 italic font-serif-film text-sm md:text-base leading-relaxed tracking-wider px-8
                                                    ${j.text.includes("意外中断")?"text-red-800 font-bold animate-pulse":""}
                                                `,children:X?Be.map((oe,Ie)=>o.jsx("span",{className:"block mb-2",children:L(oe)},Ie)):L(j.text)})}):o.jsxs("div",{className:"flex flex-col gap-1",children:[j.speaker&&O(j.id,j.speaker)&&o.jsx("span",{className:`
                                                    text-[10px] uppercase tracking-[0.2em] font-mono mb-1 ml-1
                                                    ${U(j.speaker)}
                                                `,children:j.speaker}),o.jsx("p",{className:`
                                                font-serif-film text-lg md:text-xl leading-relaxed pl-4 border-l-2
                                                ${J(j.speaker||"")}
                                            `,children:L(j.text)})]})},j.id)})})]})]}):o.jsx("div",{className:"text-stone-700 font-mono text-xs tracking-widest text-center animate-pulse",children:"NO TAPE LOADED"})]})]}),o.jsx(Xh,{text:pe("recorderTutorial",ce),isVisible:P,onClose:xe})]})},Hh=["Tanqueray Gin","Glen grant","sotol","mezcal","rye","bourbon","singani","flying king rum","g'vine","shochu","vodka","brandy","apple jack","fernet hunter","dolin dry","angostura","amontillado","manzanilla","Montenegro","heering","disaronno","bonal","benedictine","ancho reyes","frangelico","averna","cynar","campari","bigallet china-china","maraschino","fernet branca"],Bh=["ancho reyes","frangelico","averna","cynar","campari","bigallet china-china","maraschino","fernet branca","Tanqueray Gin","Glen grant","sotol","mezcal","rye","bourbon","singani","flying king rum","g'vine","shochu","vodka","brandy","apple jack"],Uh=["fernet hunter","dolin dry","angostura","amontillado","manzanilla","Montenegro","heering","disaronno","bonal","benedictine","ancho reyes","frangelico","averna","cynar","campari","bigallet china-china","maraschino","fernet branca","Tanqueray Gin","Glen grant","sotol","mezcal","rye","bourbon","singani","flying king rum","g'vine","shochu","vodka","brandy","apple jack"],Vh=["fernet hunter","dolin dry","angostura","amontillado","manzanilla","Montenegro","heering","disaronno","bonal","benedictine","ancho reyes","frangelico","averna","cynar","campari","bigallet china-china","maraschino","fernet branca","Tanqueray Gin","Glen grant","sotol","mezcal","rye","bourbon","singani","flying king rum","g'vine","shochu","vodka","brandy","apple jack"],Kp=({onBack:m,unlockedBlogs:A,onUnlockBlog:E,onViewChange:f,isFlickerDisabled:z=!1,onToggleFlicker:C})=>{const{language:T}=en(),[q,I]=M.useState(""),[x,V]=M.useState(null),[R,W]=M.useState(""),[Le,ke]=M.useState(null),[ze,Je]=M.useState(!1);M.useEffect(()=>{if(!localStorage.getItem("the-missing-reel-notebook-tutorial-seen")){const N=setTimeout(()=>Je(!0),1500);return()=>clearTimeout(N)}},[]);const Me=()=>{Je(!1),localStorage.setItem("the-missing-reel-notebook-tutorial-seen","true")},[le,P]=M.useState(!1),[me,xe]=M.useState(!1),[we,K]=M.useState(["???","???","???","???"]),[ne,_e]=M.useState(!1),[st,Ne]=M.useState(0),[Be,Oe]=M.useState(!1),[ue,De]=M.useState(0),_=$i.find(u=>u.id==="intro");M.useEffect(()=>{f==null||f(Le!==null)},[Le,f]);const D=()=>{const u=q.toLowerCase().trim();if(!u)return;if(u==="dram elysium"){xe(!0),setTimeout(()=>{P(!0),xe(!1),I(""),W(""),K(["READY","TO","SPIN","..."])},800);return}const N=u.replace("！","!"),O=$i.find(L=>L.password.toLowerCase()===N);O?(A.includes(O.id)?(W("该日志已解锁。"),ke(O.id)):(E(O.id),V(O.title),setTimeout(()=>V(null),1500),W(""),ke(O.id)),I("")):W("鸡尾酒配方没10000个也有9000个，这么试是学不到真本事的")},G=()=>{if(ne)return;_e(!0),Ne(L=>L+1);let u=0;const N=20,O=setInterval(()=>{K([Hh[Math.floor(Math.random()*Hh.length)],Bh[Math.floor(Math.random()*Bh.length)],Uh[Math.floor(Math.random()*Uh.length)],Vh[Math.floor(Math.random()*Vh.length)]]),u++,u>=N&&(clearInterval(O),_e(!1))},80)},ie=u=>u.split(/(\[IMAGE:[^\]]+\])/g).map((O,L)=>{const U=O.match(/\[IMAGE:([^\]]+)\]/);if(U){const ce=U[1];return o.jsx("div",{className:"my-6 flex justify-center",children:o.jsx("img",{src:B(ce),alt:"Decoration",className:"max-w-[200px] h-auto rounded-sm shadow-md border-2 border-stone-200 bg-white p-2"})},`img-${L}`)}return O.split(/__([^_]+)__/g).map((ce,j)=>j%2===1?o.jsx("span",{className:"font-bold text-red-600 border-b-2 border-red-500/40 px-1 transform -rotate-2 inline-block",children:ce},`${L}-${j}`):o.jsx("span",{children:ce},`${L}-${j}`))}),ye=u=>{const{content:N}=u,O="💡 更新",L=N.split(O),U=L[0],J=L.length>1?L.slice(1).join(O):null,ce=U.indexOf(`

`);let j="",X=U;if(ce!==-1){const ee=U.substring(0,ce).trim();/[0-9]/.test(ee)&&/[a-zA-Z]/.test(ee)&&(j=ee,X=U.substring(ce).trim())}return o.jsxs(o.Fragment,{children:[j&&o.jsxs("div",{className:"mb-8 border border-stone-300 p-6 bg-[#fcfbf9] shadow-sm relative mx-2 text-center",children:[o.jsx("div",{className:"absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-2 text-[10px] font-mono tracking-widest text-stone-400 uppercase",children:"COCKTAIL RECIPE"}),(()=>{const ee=j.split(`
