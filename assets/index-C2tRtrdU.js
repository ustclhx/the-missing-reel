(function(){const A=document.createElement("link").relList;if(A&&A.supports&&A.supports("modulepreload"))return;for(const z of document.querySelectorAll('link[rel="modulepreload"]'))f(z);new MutationObserver(z=>{for(const C of z)if(C.type==="childList")for(const N of C.addedNodes)N.tagName==="LINK"&&N.rel==="modulepreload"&&f(N)}).observe(document,{childList:!0,subtree:!0});function E(z){const C={};return z.integrity&&(C.integrity=z.integrity),z.referrerPolicy&&(C.referrerPolicy=z.referrerPolicy),z.crossOrigin==="use-credentials"?C.credentials="include":z.crossOrigin==="anonymous"?C.credentials="omit":C.credentials="same-origin",C}function f(z){if(z.ep)return;z.ep=!0;const C=E(z);fetch(z.href,C)}})();function Yh(m){return m&&m.__esModule&&Object.prototype.hasOwnProperty.call(m,"default")?m.default:m}var br={exports:{}},Ol={};/**
 * @license React
 ...
 */var jh;function gp(){if(jh)return Ol;jh=1;var m=Symbol.for("react.transitional.element"),A=Symbol.for("react.fragment");function E(f,z,C){var N=null;if(C!==void 0&&(N=""+C),z.key!==void 0&&(N=""+z.key),"key"in z){C={};for(var q in z)q!=="key"&&(C[q]=z[q])}else C=z;return z=C.ref,{$$typeof:m,type:f,key:N,ref:z!==void 0?z:null,props:C}}return Ol.Fragment=A,Ol.jsx=E,Ol.jsxs=E,Ol}var Nh;function bp(){return Nh||(Nh=1,br.exports=gp()),br.exports}var o=bp(),vr={exports:{}},F={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Th;function vp(){if(Th)return F;Th=1;var m=Symbol.for("react.transitional.element"),A=Symbol.for("react.portal"),E=Symbol.for("react.fragment"),f=Symbol.for("react.strict_mode"),z=Symbol.for("react.profiler"),C=Symbol.for("react.consumer"),N=Symbol.for("react.context"),q=Symbol.for("react.forward_ref"),I=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),V=Symbol.for("react.lazy"),R=Symbol.for("react.activity"),W=Symbol.iterator;function Le(d){return d===null||typeof d!="object"?null:(d=W&&d[W]||d["@@iterator"],typeof d=="function"?d:null)}var ke={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ze=Object.assign,Je={};function Me(d,u,j){this.props=d,this.context=u,this.refs=Je,this.updater=j||ke}Me.prototype.isReactComponent={},Me.prototype.setState=function(d,u){if(typeof d!="object"&&typeof d!="function"&&d!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,d,u,"setState")},Me.prototype.forceUpdate=function(d){this.updater.enqueueForceUpdate(this,d,"forceUpdate")};function ie(){}ie.prototype=Me.prototype;function P(d,u,j){this.props=d,this.context=u,this.refs=Je,this.updater=j||ke}var pe=P.prototype=new ie;pe.constructor=P,ze(pe,Me.prototype),pe.isPureReactComponent=!0;var xe=Array.isArray;function we(){}var K={H:null,A:null,T:null,S:null},le=Object.prototype.hasOwnProperty;function _e(d,u,j){var O=j.ref;return{$$typeof:m,type:d,key:u,ref:O!==void 0?O:null,props:j}}function st(d,u){return _e(d.type,u,d.props)}function je(d){return typeof d=="object"&&d!==null&&d.$$typeof===m}function Be(d){var u={"=":"=0",":":"=2"};return"$"+d.replace(/[=:]/g,function(j){return u[j]})}var Oe=/\/+/g;function ce(d,u){return typeof d=="object"&&d!==null&&d.key!=null?Be(""+d.key):u.toString(36)}function De(d){switch(d.status){case"fulfilled":return d.value;case"rejected":throw d.reason;default:switch(typeof d.status=="string"?d.then(we,we):(d.status="pending",d.then(function(u){d.status==="pending"&&(d.status="fulfilled",d.value=u)},function(u){d.status==="pending"&&(d.status="rejected",d.reason=u)})),d.status){case"fulfilled":return d.value;case"rejected":throw d.reason}}throw d}function _(d,u,j,O,L){var U=typeof d;(U==="undefined"||U==="boolean")&&(d=null);var J=!1;if(d===null)J=!0;else switch(U){case"bigint":case"string":case"number":J=!0;break;case"object":switch(d.$$typeof){case m:case A:J=!0;break;case V:return J=d._init,_(J(d._payload),u,j,O,L)}}if(J)return L=L(d),J=O===""?"."+ce(d,0):O,xe(L)?(j="",J!=null&&(j=J.replace(Oe,"$&/")+"/"),_(L,u,j,"",function(X){return X})):L!=null&&(je(L)&&(L=st(L,j+(L.key==null||d&&d.key===L.key?"":(""+L.key).replace(Oe,"$&/")+"/")+J)),u.push(L)),1;J=0;var de=O===""?".":O+":";if(xe(d))for(var T=0;T<d.length;T++)O=d[T],U=de+ce(O,T),J+=_(O,u,j,U,L);else if(T=Le(d),typeof T=="function")for(d=T.call(d),T=0;!(O=d.next()).done;)O=O.value,U=de+ce(O,T++),J+=_(O,u,j,U,L);else if(U==="object"){if(typeof d.then=="function")return _(De(d),u,j,O,L);throw u=String(d),Error("Objects are not valid as a React child (found: "+(u==="[object Object]"?"object with keys {"+Object.keys(d).join(", ")+"}":u)+"). If you meant to render a collection of children, use an array instead.")}return J}function D(d,u,j){if(d==null)return d;var O=[],L=0;return _(d,O,"","",function(U){return u.call(j,U,L++)}),O}function G(d){if(d._status===-1){var u=d._result;u=u(),u.then(function(j){(d._status===0||d._status===-1)&&(d._status=1,d._result=j)},function(j){(d._status===0||d._status===-1)&&(d._status=2,d._result=j)}),d._status===-1&&(d._status=0,d._result=u)}if(d._status===1)return d._result.default;throw d._result}var oe=typeof reportError=="function"?reportError:function(d){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var u=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof d=="object"&&d!==null&&typeof d.message=="string"?String(d.message):String(d),error:d});if(!window.dispatchEvent(u))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",d);return}console.error(d)},ye={map:D,forEach:function(d,u,j){D(d,function(){u.apply(this,arguments)},j)},count:function(d){var u=0;return D(d,function(){u++}),u},toArray:function(d){return D(d,function(u){return u})||[]},only:function(d){if(!je(d))throw Error("React.Children.only expected to receive a single React element child.");return d}};return F.Activity=R,F.Children=ye,F.Component=Me,F.Fragment=E,F.Profiler=z,F.PureComponent=P,F.StrictMode=f,F.Suspense=I,F.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=K,F.__COMPILER_RUNTIME={__proto__:null,c:function(d){return K.H.useMemoCache(d)}},F.cache=function(d){return function(){return d.apply(null,arguments)}},F.cacheSignal=function(){return null},F.cloneElement=function(d,u,j){if(d==null)throw Error("The argument must be a React element, but you passed "+d+".");var O=ze({},d.props),L=d.key;if(u!=null)for(U in u.key!==void 0&&(L=""+u.key),u)!le.call(u,U)||U==="key"||U==="__self"||U==="__source"||U==="ref"&&u.ref===void 0||(O[U]=u[U]);var U=arguments.length-2;if(U===1)O.children=j;else if(1<U){for(var J=Array(U),de=0;de<U;de++)J[de]=arguments[de+2];O.children=J}return _e(d.type,L,O)},F.createContext=function(d){return d={$$typeof:N,_currentValue:d,_currentValue2:d,_threadCount:0,Provider:null,Consumer:null},d.Provider=d,d.Consumer={$$typeof:C,_context:d},d},F.createElement=function(d,u,j){var O,L={},U=null;if(u!=null)for(O in u.key!==void 0&&(U=""+u.key),u)le.call(u,O)&&O!=="key"&&O!=="__self"&&O!=="__source"&&(L[O]=u[O]);var J=arguments.length-2;if(J===1)L.children=j;else if(1<J){for(var de=Array(J),T=0;T<J;T++)de[T]=arguments[T+2];L.children=de}if(d&&d.defaultProps)for(O in J=d.defaultProps,J)L[O]===void 0&&(L[O]=J[O]);return _e(d,U,L)},F.createRef=function(){return{current:null}},F.forwardRef=function(d){return{$$typeof:q,render:d}},F.isValidElement=je,F.lazy=function(d){return{$$typeof:V,_payload:{_status:-1,_result:d},_init:G}},F.memo=function(d,u){return{$$typeof:x,type:d,compare:u===void 0?null:u}},F.startTransition=function(d){var u=K.T,j={};K.T=j;try{var O=d(),L=K.S;L!==null&&L(j,O),typeof O=="object"&&O!==null&&typeof O.then=="function"&&O.then(we,oe)}catch(U){oe(U)}finally{u!==null&&j.types!==null&&(u.types=j.types),K.T=u}},F.unstable_useCacheRefresh=function(){return K.H.useCacheRefresh()},F.use=function(d){return K.H.use(d)},F.useActionState=function(d,u,j){return K.H.useActionState(d,u,j)},F.useCallback=function(d,u){return K.H.useCallback(d,u)},F.useContext=function(d){return K.H.useContext(d)},F.useDebugValue=function(){},F.useDeferredValue=function(d,u){return K.H.useDeferredValue(d,u)},F.useEffect=function(d,u){return K.H.useEffect(d,u)},F.useEffectEvent=function(d){return K.H.useEffectEvent(d)},F.useId=function(){return K.H.useId()},F.useImperativeHandle=function(d,u,j){return K.H.useImperativeHandle(d,u,j)},F.useInsertionEffect=function(d,u){return K.H.useInsertionEffect(d,u)},F.useLayoutEffect=function(d,u){return K.H.useLayoutEffect(d,u)},F.useMemo=function(d,u){return K.H.useMemo(d,u)},F.useOptimistic=function(d,u){return K.H.useOptimistic(d,u)},F.useReducer=function(d,u,j){return K.H.useReducer(d,u,j)},F.useRef=function(d){return K.H.useRef(d)},F.useState=function(d){return K.H.useState(d)},F.useSyncExternalStore=function(d,u,j){return K.H.useSyncExternalStore(d,u,j)},F.useTransition=function(){return K.H.useTransition()},F.version="19.2.3",F}var Eh;function jr(){return Eh||(Eh=1,vr.exports=vp()),vr.exports}var M=jr();const _p=Yh(M);var _r={exports:{}},Dl={},xr={exports:{}},wr={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zh;function xp(){return zh||(zh=1,(function(m){function A(_,D){var G=_.length;_.push(D);e:for(;0<G;){var oe=G-1>>>1,ye=_[oe];if(0<z(ye,D))_[oe]=D,_[G]=ye,G=oe;else break e}}function E(_){return _.length===0?null:_[0]}function f(_){if(_.length===0)return null;var D=_[0],G=_.pop();if(G!==D){_[0]=G;e:for(var oe=0,ye=_.length,d=ye>>>1;oe<d;){var u=2*(oe+1)-1,j=_[u],O=u+1,L=_[O];if(0>z(j,G))O<ye&&0>z(L,j)?(_[oe]=L,_[O]=G,oe=O):(_[oe]=j,_[u]=G,oe=u);else if(O<ye&&0>z(L,G))_[oe]=L,_[O]=G,oe=O;else break e}}return D}function z(_,D){var G=_.sortIndex-D.sortIndex;return G!==0?G:_.id-D.id}if(m.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var C=performance;m.unstable_now=function(){return C.now()}}else{var N=Date,q=N.now();m.unstable_now=function(){return N.now()-q}}var I=[],x=[],V=1,R=null,W=3,Le=!1,ke=!1,ze=!1,Je=!1,Me=typeof setTimeout=="function"?setTimeout:null,ie=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function pe(_){for(var D=E(x);D!==null;){if(D.callback===null)f(x);else if(D.startTime<=_)f(x),D.sortIndex=D.expirationTime,A(I,D);else break;D=E(x)}}function xe(_){if(ze=!1,pe(_),!ke)if(E(I)!==null)ke=!0,we||(we=!0,Be());else{var D=E(x);D!==null&&De(xe,D.startTime-_)}}var we=!1,K=-1,le=5,_e=-1;function st(){return Je?!0:!(m.unstable_now()-_e<le)}function je(){if(Je=!1,we){var _=m.unstable_now();_e=_;var D=!0;try{e:{ke=!1,ze&&(ze=!1,ie(K),K=-1),Le=!0;var G=W;try{t:{for(pe(_),R=E(I);R!==null&&!(R.expirationTime>_&&st());){var oe=R.callback;if(typeof oe=="function"){R.callback=null,W=R.priorityLevel;var ye=oe(R.expirationTime<=_);if(_=m.unstable_now(),typeof ye=="function"){R.callback=ye,pe(_),D=!0;break t}R===E(I)&&f(I),pe(_)}else f(I);R=E(I)}if(R!==null)D=!0;else{var d=E(x);d!==null&&De(xe,d.startTime-_),D=!1}}break e}finally{R=null,W=G,Le=!1}D=void 0}}finally{D?Be():we=!1}}}var Be;if(typeof P=="function")Be=function(){P(je)};else if(typeof MessageChannel<"u"){var Oe=new MessageChannel,ce=Oe.port2;Oe.port1.onmessage=je,Be=function(){ce.postMessage(null)}}else Be=function(){Me(je,0)};function De(_,D){K=Me(function(){_(m.unstable_now())},D)}m.unstable_IdlePriority=5,m.unstable_ImmediatePriority=1,m.unstable_LowPriority=4,m.unstable_NormalPriority=3,m.unstable_Profiling=null,m.unstable_UserBlockingPriority=2,m.unstable_cancelCallback=function(_){_.callback=null},m.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):le=0<_?Math.floor(1e3/_):5},m.unstable_getCurrentPriorityLevel=function(){return W},m.unstable_next=function(_){switch(W){case 1:case 2:case 3:var D=3;break;default:D=W}var G=W;W=D;try{return _()}finally{W=G}},m.unstable_requestPaint=function(){Je=!0},m.unstable_runWithPriority=function(_,D){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var G=W;W=_;try{return D()}finally{W=G}},m.unstable_scheduleCallback=function(_,D,G){var oe=m.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?oe+G:oe):G=oe,_){case 1:var ye=-1;break;case 2:ye=250;break;case 5:ye=1073741823;break;case 4:ye=1e4;break;default:ye=5e3}return ye=G+ye,_={id:V++,callback:D,priorityLevel:_,startTime:G,expirationTime:ye,sortIndex:-1},G>oe?(_.sortIndex=G,A(x,_),E(I)===null&&_===E(x)&&(ze?(ie(K),K=-1):ze=!0,De(xe,G-oe))):(_.sortIndex=ye,A(I,_),ke||Le||(ke=!0,we||(we=!0,Be()))),_},m.unstable_shouldYield=st,m.unstable_wrapCallback=function(_){var D=W;return function(){var G=W;W=D;try{return _.apply(this,arguments)}finally{W=G}}}})(wr)),wr}var Mh;function wp(){return Mh||(Mh=1,xr.exports=xp()),xr.exports}var Sr={exports:{}},rt={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ih;function kp(){if(Ih)return Dl;Ih=1;var m=wp(),A=jr(),E=Ap();function f(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)t+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function z(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function C(e){var t=e,a=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(a=t.return),e=t.return;while(e)}return t.tag===3?a:null}function N(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function q(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function I(e){if(C(e)!==e)throw Error(f(188))}function x(e){var t=e.alternate;if(!t){if(t=C(e),t===null)throw Error(f(188));return t!==e?null:e}for(var a=e,n=t;;){var l=a.return;if(l===null)break;var i=l.alternate;if(i===null){if(n=l.return,n!==null){a=n;continue}break}if(l.child===i.child){for(i=l.child;i;){if(i===a)return I(l),e;if(i===n)return I(l),t;i=i.sibling}throw Error(f(188))}if(a.return!==n.return)a=l,n=i;else{for(var s=!1,r=l.child;r;){if(r===a){s=!0,a=l,n=i;break}if(r===n){s=!0,n=l,a=i;break}r=r.sibling}if(!s){for(r=i.child;r;){if(r===a){s=!0,a=i,n=l;break}if(r===n){s=!0,n=i,a=l;break}r=r.sibling}if(!s)throw Error(f(189))}}if(a.alternate!==n)throw Error(f(190))}if(a.tag!==3)throw Error(f(188));return a.stateNode.current===a?e:t}function V(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=V(e),t!==null)return t;e=e.sibling}return null}var R=Object.assign,W=Symbol.for("react.element"),Le=Symbol.for("react.transitional.element"),ke=Symbol.for("react.portal"),ze=Symbol.for("react.fragment"),Je=Symbol.for("react.strict_mode"),Me=Symbol.for("react.profiler"),ie=Symbol.for("react.consumer"),P=Symbol.for("react.context"),pe=Symbol.for("react.forward_ref"),xe=Symbol.for("react.suspense"),we=Symbol.for("react.suspense_list"),K=Symbol.for("react.memo"),le=Symbol.for("react.lazy"),_e=Symbol.for("react.activity"),st=Symbol.for("react.memo_cache_sentinel"),je=Symbol.iterator;function Be(e){return e===null||typeof e!="object"?null:(e=je&&e[je]||e["@@iterator"],typeof e=="function"?e:null)}var Oe=Symbol.for("react.client.reference");function ce(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Oe?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case ze:return"Fragment";case Me:return"Profiler";case Je:return"StrictMode";case xe:return"Suspense";case we:return"SuspenseList";case _e:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case ke:return"Portal";case P:return e.displayName||"Context";case ie:return(e._context.displayName||"Context")+".Consumer";case pe:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case K:return t=e.displayName||null,t!==null?t:ce(e.type)||"Memo";case le:t=e._payload,e=e._init;try{return ce(e(t))}catch{}}return null}var De=Array.isArray,_=A.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,D=E.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G={pending:!1,data:null,method:null,action:null},oe=[],ye=-1;function d(e){return{current:e}}function u(e){0>ye||(e.current=oe[ye],oe[ye]=null,ye--)}function j(e,t){ye++,oe[ye]=e.current,e.current=t}var O=d(null),L=d(null),U=d(null),J=d(null);function de(e,t){switch(j(U,t),j(L,e),j(O,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?Jd(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=Jd(t),e=Wd(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}u(O),j(O,e)}function T(){u(O),u(L),u(U)}function X(e){e.memoizedState!==null&&j(J,e);var t=O.current,a=Wd(t,e.type);t!==a&&(j(L,e),j(O,a))}function ee(e){L.current===e&&(u(O),u(L)),J.current===e&&(u(J),Tl._currentValue=G)}var se,Ie;function tt(e){if(se===void 0)try{throw Error()}catch(a){var t=a.stack.trim().match(/\n( *(at )?)/);se=t&&t[1]||"",Ie=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+se+e+Ie}var $e=!1;function We(e,t){if(!e||$e)return"";$e=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var n={DetermineComponentFrameRoot:function(){try{if(t){var k=function(){throw Error()};if(Object.defineProperty(k.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(k,[])}catch(v){var b=v}Reflect.construct(e,[],k)}else{try{k.call()}catch(v){b=v}e.call(k.prototype)}}else{try{throw Error()}catch(v){b=v}(k=e())&&typeof k.catch=="function"&&k.catch(function(){})}}catch(v){if(v&&b&&typeof v.stack=="string")return[v.stack,b.stack]}return[null,null]}};n.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var l=Object.getOwnPropertyDescriptor(n.DetermineComponentFrameRoot,"name");l&&l.configurable&&Object.defineProperty(n.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var i=n.DetermineComponentFrameRoot(),s=i[0],r=i[1];if(s&&r){var c=s.split(`
`),g=r.split(`
...
不过总之，如果她到时候会来，那给她做个__Little Italy__的升级版，大概也算惊喜？`}],Lp=[{id:"reel_01",reelNumber:1,code:[0,0,0,0],label:"First Roll",contentTitle:"First Roll",contentDesc:"模糊的画面里，一个人在酒吧里做酒，完成之后镜头不断推进，拍下放在三角杯中的特写。旁边的杯垫上写 50/50 Martini。",contentImage:[B("/assets/film_01.jpg"),B("/assets/film_02.jpg")]},{id:"reel_02",reelNumber:2,code:[0,0,0,2],label:"Second Roll",contentTitle:"Second Roll",contentDesc:"模糊的画面里，一个高个子在酒吧里做酒，完成之后镜头不断推进，拍下放在三角杯中的特写。旁边的杯垫上写 Steph。",contentImage:[B("/assets/film_02_1.jpg"),B("/assets/film_02_2.jpg")]},{id:"reel_03",reelNumber:3,code:[0,0,2,0],label:"Film 4",contentTitle:"Film 4",contentDesc:"模糊的画面里，一个高个子在吧台里摇酒，完成之后镜头不断推进，拍下放在三角杯中的特写。旁边的杯垫上写Whisky Sour。",contentImage:[B("/assets/film_03_1.jpg"),B("/assets/film_03_2.jpg")]},{id:"reel_04",reelNumber:4,code:[0,2,0,0],label:"Fourth Roll",contentTitle:"Fourth Roll",contentDesc:"晃动的画面，人影纠缠在一起，几乎没有拍到任何清晰图像。第二张内容中，一把钥匙落在地上，拍摄者用鞋将其踩住。",contentImage:[B("/assets/film_04_1.jpg"),B("/assets/film_04_2.jpg")]},{id:"reel_06",reelNumber:5,code:[2,0,0,0],label:"Film 6",contentTitle:"Film 6",contentDesc:"在昏黄的夜色中，一片狼藉的废墟堆在大街中央，与侧后方的现代建筑形成鲜明对比。远处的灯光与楼宇被笼罩在一层朦胧的雾气与虚焦中，仿佛一段尘封已久的陈旧记忆。",contentImage:B("/assets/film_06.jpg")},{id:"reel_07",reelNumber:6,code:[2,2,2,2],label:"Film 7",contentTitle:"Film 7",contentDesc:"斑驳的暗色背景上，一首充满克苏鲁与诗意感的随笔出现在画面中。内容提到“虫洞”、“女权”与“返祖现象”，署名为一个鲜红的感叹号。",contentImage:B("/assets/film_07.jpg")},{id:"reel_00",reelNumber:0,code:[4,4,4,4],label:"Reel 0",contentTitle:"Reel 0",contentDesc:"这是一堆被剪碎的不连续的胶卷，看起来是一个阴暗的酒吧废墟，其中几张展现出烟头烙印一般的白斑，看起来不同寻常。",contentImage:[B("/assets/film_00_3.jpg"),B("/assets/film_00_4.jpg"),B("/assets/film_00_5.jpg"),B("/assets/film_00_6.jpg"),B("/assets/film_00_7.jpg"),B("/assets/film_00_8.jpg"),B("/assets/film_00_9.jpg")]},{id:"reel_ghost",reelNumber:-1,code:[0,0,0,0],label:"Film 3",contentTitle:"Film 3",contentDesc:"晃动的画面，看起来是在老店，拍摄者把摄影机递给孟奇，孟奇拍下了拍摄者自己的样貌和手举名牌的图像。一人手持标有《行为艺术与心灵治愈》的书籍图片被拍下。",contentImage:B("/assets/film_03.jpg")},{id:"reel_08",reelNumber:-2,code:[2,0,0,0],label:"Film 8",contentTitle:"Film 8",contentDesc:"在昏暗而幽闭的空间里，一叠书脊上印着《Are bats rats？》的样书静静地堆放着。厚重的阴影吞噬了大部分光线，微弱的回扣让书脊上的字迹显得格外苍白而诡异，透出一种压抑的怀旧气息。",contentImage:B("/assets/film_08.jpg")},{id:"reel_09",reelNumber:-3,code:[1,1,1,1],label:"Film 9",contentTitle:"Film 9",contentDesc:"在昏黄而充满颗粒感的画面中，一群年轻人席地而坐，周围散落着酒瓶与杂物。光影在墙壁上投射出沉重而幽暗的阴影，模糊的面容被笼罩在一层忧郁的怀旧感中，仿佛一段被时间遗忘的私人记录。",contentImage:B("/assets/film_09.jpg")},{id:"reel_10",reelNumber:7,code:[2,2,2,1],label:"Film Fan",contentTitle:"阿文_20221231",contentDesc:"喝醉的阿文趴在吧台沉沉睡着，手边是杯喝了一半的完美曼哈顿，旁边的书页上写着「电影迷」by taylor soigir。",contentImage:B("/assets/film_10.jpg")},{id:"reel_11",reelNumber:8,code:[2,2,1,2],label:"Jam 12.18",contentTitle:"Jam 12.18",contentDesc:"吧台内的调酒师满怀期待地端起酒杯，面前的杯垫上写着配方：Jam 12.18。",contentImage:[B("/assets/film_11_1.jpg"),B("/assets/film_11_2.jpg")]}],Rp={recorder:B("/assets/recorder_music.mp3"),notebook:B("/assets/recorder_music.mp3"),film:B("/assets/film_music.mp3")},qh=Object.freeze(Object.defineProperty({__proto__:null,AUDIO_LOGS:Ip,BLOG_ENTRIES:Cp,FILM_ARCHIVE:Lp,INITIAL_ITEMS:Dp,MUSIC_TRACKS:Rp},Symbol.toStringTag,{value:"Module"})),Hp=[{id:"recorder",name:"Voice Recorder",icon:"📼",description:"Contains cassette tapes with recorded conversations."},{id:"notebook",name:"Blog Archive",icon:"💻",description:"Password-protected archive of historical logs."},{id:"film",name:"8mm Film Reels",icon:"🎞️",description:"40 reels total, marked with 4 different glass shapes for ordering. Each reel shows no more than 2 glass types."}],Bp=[{id:"log_auto",searchId:"AUTO_PLAY",title:"Ash_20201020",isAutoPlay:!0,locked:!1,content:`
...
`).map(ee=>ee.trim()).filter(ee=>ee.length>0).map((ee,se)=>{if(ee.startsWith("（")||ee.startsWith("("))return{id:se,speaker:null,text:ee,type:"direction"};const Ie=ee.match(/^([^：:]+)[：:](.+)$/);return Ie?{id:se,speaker:Ie[1].trim(),text:Ie[2].trim(),type:"dialogue"}:{id:se,speaker:null,text:ee,type:"direction"}}),ye=()=>{const T=x.trim(),X=R.trim();if(!T||!X){ke("请输入完整的姓名和日期。");return}const ee=`${T}_${X}`.toLowerCase(),se=Ar.find(Ie=>Ie.searchId.toLowerCase()===ee);se?A.includes(se.id)?(ke("该录音已存在于列表中。"),d(se)):(E(se.id),ke("检索成功。加载中..."),setTimeout(()=>{d(se),V(""),W("")},1e3)):ke("错误：未找到对应编号的录音。")},d=T=>{G.current&&clearTimeout(G.current);const X=oe(T.content);if(Je(X),ie(0),I(T),X.length>0&&X[0].type==="direction"){const se=X[0].text.split(/([，。；！])/).reduce((We,Vt,Ca)=>(Vt.match(/[，。；！]/)&&Ca>0?We[We.length-1]+=Vt:Vt.trim()&&We.push(Vt),We),[]);Oe(se),De(0),D(!1);const Ie=se.join("").length;let tt=0;const $e=()=>{if(tt++,De(tt),tt<Ie){const We=Math.random()*30+30;G.current=setTimeout($e,We)}else setTimeout(()=>{D(!0),N==null||N()},500)};$e()}else Oe([]),D(!0),N==null||N()};M.useEffect(()=>()=>{G.current&&clearTimeout(G.current)},[]),M.useEffect(()=>{if(f)return;const T=Ar.find(X=>X.isAutoPlay);T&&A.includes(T.id)&&(z(!0),setTimeout(()=>{d(T)},500))},[f,A,z]);const u=M.useMemo(()=>{const T=Me*kr;return ze.slice(T,T+kr)},[ze,Me]),j=Math.ceil(ze.length/kr),O=(T,X)=>ze.find((se,Ie)=>Ie<T&&se.speaker===X)?null:X,L=T=>T.split(/__([^_]+)__/g).map((ee,se)=>se%2===1?o.jsx("span",{className:"text-red-400 border-b border-red-500/40 pb-0.5 mx-1 font-bold tracking-wider",children:ee},se):o.jsx("span",{children:ee},se)),U=T=>T.includes("陌生人1")||T.includes("Stranger 1")?"text-red-600 font-bold":T.includes("苹果")||T.includes("Apple")?"text-stone-400":"text-amber-700",J=T=>T.includes("陌生人1")||T.includes("Stranger 1")?"text-red-500/90 border-red-900/50 glitch-text":T.includes("苹果")||T.includes("Apple")?"text-stone-200 border-stone-600":"text-amber-500/90 border-amber-900/50",{language:de}=en();return o.jsxs("div",{className:"flex-1 flex flex-col bg-stone-900 relative",children:[o.jsxs("div",{className:"h-14 sm:h-16 border-b border-stone-800 flex items-center justify-between px-3 sm:px-6 bg-stone-900 shadow-md z-10",children:[o.jsx("button",{onClick:m,className:"text-stone-400 hover:text-white text-[10px] sm:text-xs font-mono tracking-widest uppercase shrink-0",children:"[ OFF ]"}),o.jsxs("div",{className:"flex items-center gap-2 sm:gap-4 flex-1 justify-end",children:[o.jsx("span",{className:"text-[10px] text-stone-400 uppercase tracking-widest hidden lg:inline",children:"Tape Index:"}),o.jsxs("div",{className:"flex bg-stone-800/80 border border-stone-700 rounded-sm overflow-hidden group focus-within:border-stone-500 transition-colors items-center",children:[o.jsx("input",{type:"text",value:x,onChange:T=>V(T.target.value),placeholder:"姓名",className:"bg-transparent text-stone-100 px-1.5 sm:px-2 py-1 text-xs sm:text-sm focus:outline-none w-14 sm:w-20 text-center font-serif-film placeholder-stone-600"}),o.jsx("span",{className:"text-stone-400 font-mono select-none text-xs",children:"_"}),o.jsx("input",{type:"text",value:R,onChange:T=>W(T.target.value),placeholder:"日期",className:"bg-transparent text-stone-100 px-1.5 sm:px-2 py-1 text-xs sm:text-sm focus:outline-none w-16 sm:w-24 text-center font-serif-film placeholder-stone-600"}),o.jsx("button",{onClick:ye,className:"text-stone-300 bg-stone-700 px-2 sm:px-3 py-1 text-[10px] sm:text-xs border-l border-stone-600 hover:bg-stone-600 hover:text-white transition-colors h-full",children:"PLAY"})]})]})]}),o.jsxs("div",{className:"flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden relative",children:[o.jsxs("div",{className:`
        ...
        `,children:[o.jsx("div",{className:"p-4 border-b border-stone-800 text-[10px] text-stone-400 font-mono text-center tracking-widest",children:"ARCHIVED RECORDINGS"}),o.jsxs("div",{className:"flex-1 overflow-y-auto p-2 space-y-2 scrollbar-hide",children:[Le!=="等待输入..."&&o.jsx("div",{className:"text-xs text-amber-500 p-2 font-mono text-center animate-pulse",children:Le}),je.map(T=>{const X=(q==null?void 0:q.id)===T.id;return o.jsxs("button",{onClick:()=>d(T),className:`
                            ...
                            `,children:[o.jsxs("div",{className:"flex items-baseline justify-between relative z-10",children:[o.jsx("span",{className:`font-mono text-xs ${X?"text-amber-500":"text-stone-600 group-hover:text-stone-500"}`,children:X?"● PLAYING":"○ READY"}),X&&o.jsxs("span",{className:"text-[10px] animate-pulse",children:["00:0",Math.floor(Math.random()*9),"..."]})]}),o.jsx("div",{className:"mt-2 font-serif-film text-sm tracking-wide truncate relative z-10",children:T.title})]},T.id)})]}),st>1&&o.jsxs("div",{className:"p-2 border-t border-stone-800 flex justify-between items-center bg-stone-900",children:[o.jsx("button",{onClick:()=>K(T=>Math.max(0,T-1)),disabled:we===0,className:"text-stone-500 hover:text-stone-300 disabled:opacity-30 disabled:hover:text-stone-500 px-2 py-1 text-xs font-mono",children:"< PREV"}),o.jsxs("span",{className:"text-[10px] text-stone-600 font-mono",children:["PG ",we+1,"/",st]}),o.jsx("button",{onClick:()=>K(T=>Math.min(st-1,T+1)),disabled:we===st-1,className:"text-stone-500 hover:text-stone-300 disabled:opacity-30 disabled:hover:text-stone-500 px-2 py-1 text-xs font-mono",children:"NEXT >"})]})]}),o.jsxs("div",{className:"flex-1 bg-black relative flex flex-col items-center justify-center p-6 overflow-y-auto",children:[o.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(30,30,30,1)_0%,rgba(0,0,0,1)_100%)]"}),q?o.jsxs(o.Fragment,{children:[_&&j>1&&o.jsxs(o.Fragment,{children:[o.jsx("button",{onClick:()=>ie(T=>Math.max(0,T-1)),disabled:Me===0,className:"absolute left-0 top-1/2 -translate-y-1/2 z-50 p-3 md:p-4 text-stone-600 hover:text-stone-300 disabled:opacity-0 transition-all opacity-50 hover:opacity-100",children:o.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:2,stroke:"currentColor",className:"w-6 h-6 md:w-8 md:h-8",children:o.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.75 19.5L8.25 12l7.5-7.5"})})}),o.jsx("button",{onClick:()=>{Me===j-1?(q==null?void 0:q.id)==="awen_20231103"&&(C==null||C()):ie(T=>T+1)},disabled:Me===j-1&&(q==null?void 0:q.id)!=="awen_20231103",className:"absolute right-0 top-1/2 -translate-y-1/2 z-50 p-3 md:p-4 text-stone-600 hover:text-stone-300 disabled:opacity-0 transition-all opacity-50 hover:opacity-100",children:o.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:2,stroke:"currentColor",className:"w-6 h-6 md:w-8 md:h-8",children:o.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M8.25 4.5l7.5 7.5-7.5 7.5"})})}),o.jsx("div",{className:"absolute bottom-6 left-0 right-0 flex justify-center gap-3 z-50",children:Array.from({length:j}).map((T,X)=>o.jsx("div",{className:`rounded-full transition-all duration-300 ${X===Me?"w-2 h-2 bg-[#DA291C] shadow-[0_0_8px_rgba(218,41,28,0.6)]":"w-1.5 h-1.5 bg-stone-800"}`},X))})]}),o.jsxs("div",{className:"w-full max-w-2xl relative z-10 flex flex-col h-full max-h-[70vh] sm:max-h-[600px] mb-8 sm:mb-12 px-4 sm:px-8 md:px-16",children:[o.jsx("div",{className:"text-center mb-8 opacity-70",children:o.jsxs("h2",{className:"text-stone-500 text-xs font-mono tracking-[0.5em] uppercase border-b border-stone-800 pb-2 inline-block",children:[q.title," // PAGE ",Me+1]})}),o.jsx("div",{className:"flex-1 flex flex-col justify-center space-y-8 min-h-[300px]",children:u.map(T=>{const X=T.id===0;return!_&&!X?null:o.jsx("div",{className:"w-full animate-in fade-in slide-in-from-bottom-2 duration-700 fill-mode-both",children:T.type==="direction"?o.jsx("div",{className:"text-center flex flex-col gap-2 items-center",children:X&&!_?o.jsx("div",{className:"space-y-2",children:(()=>{let se=0;return Be.map((Ie,tt)=>{const $e=se,We=$e+Ie.length;if(se+=Ie.length,ce<=$e)return null;const Vt=Math.min(Ie.length,ce-$e),Ca=Ie.slice(0,Vt);return o.jsxs("p",{className:"text-stone-600 italic font-serif-film text-sm md:text-base leading-relaxed tracking-wider px-8",children:[L(Ca),ce>$e&&ce<We&&o.jsx("span",{className:"inline-block w-2 h-4 bg-stone-500 ml-1 animate-pulse align-middle"})]},tt)})})()}):o.jsx("p",{className:`
                                                ...
                                                `,children:X?Be.map((se,Ie)=>o.jsx("span",{className:"block mb-2",children:L(se)},Ie)):L(T.text)})}):o.jsxs("div",{className:"flex flex-col gap-1",children:[T.speaker&&O(T.id,T.speaker)&&o.jsx("span",{className:`
                                                ...
                                                ${J(T.speaker||"")}
                                            `,children:L(T.text)})]})},T.id)})})]})]}):o.jsx("div",{className:"text-stone-700 font-mono text-xs tracking-widest text-center animate-pulse",children:"NO TAPE LOADED"})]})]}),o.jsx(Xh,{text:ne("recorderTutorial",de),isVisible:P,onClose:xe})]})},Hh=["Tanqueray Gin","Glen grant","sotol","mezcal","rye","bourbon","singani","flying king rum","g'vine","shochu","vodka","brandy","apple jack","fernet hunter","dolin dry","angostura","amontillado","manzanilla","Montenegro","heering","disaronno","bonal","benedictine","ancho reyes","frangelico","averna","cynar","campari","bigallet china-china","maraschino","fernet branca"],Bh=["ancho reyes","frangelico","averna","cynar","campari","bigallet china-china","maraschino","fernet branca","Tanqueray Gin","Glen grant","sotol","mezcal","rye","bourbon","singani","flying king rum","g'vine","shochu","vodka","brandy","apple jack"],Uh=["fernet hunter","dolin dry","angostura","amontillado","manzanilla","Montenegro","heering","disaronno","bonal","benedictine","ancho reyes","frangelico","averna","cynar","campari","bigallet china-china","maraschino","fernet branca","Tanqueray Gin","Glen grant","sotol","mezcal","rye","bourbon","singani","flying king rum","g'vine","shochu","vodka","brandy","apple jack"],Vh=["fernet hunter","dolin dry","angostura","amontillado","manzanilla","Montenegro","heering","disaronno","bonal","benedictine","ancho reyes","frangelico","averna","cynar","campari","bigallet china-china","maraschino","fernet branca","Tanqueray Gin","Glen grant","sotol","mezcal","rye","bourbon","singani","flying king rum","g'vine","shochu","vodka","brandy","apple jack"],Kp=({onBack:m,unlockedBlogs:A,onUnlockBlog:E,onViewChange:f,isFlickerDisabled:z=!1,onToggleFlicker:C})=>{const{language:N}=en(),[q,I]=M.useState(""),[x,V]=M.useState(null),[R,W]=M.useState(""),[Le,ke]=M.useState(null),[ze,Je]=M.useState(!1);M.useEffect(()=>{if(!localStorage.getItem("the-missing-reel-notebook-tutorial-seen")){const j=setTimeout(()=>Je(!0),1500);return()=>clearTimeout(j)}},[]);const Me=()=>{Je(!1),localStorage.setItem("the-missing-reel-notebook-tutorial-seen","true")},[ie,P]=M.useState(!1),[pe,xe]=M.useState(!1),[we,K]=M.useState(["???","???","???","???"]),[le,_e]=M.useState(!1),[st,je]=M.useState(0),[Be,Oe]=M.useState(!1),[ce,De]=M.useState(0),_=$i.find(u=>u.id==="intro");M.useEffect(()=>{f==null||f(Le!==null)},[Le,f]);const D=()=>{const u=q.toLowerCase().trim();if(!u)return;if(u==="dram elysium"){xe(!0),setTimeout(()=>{P(!0),xe(!1),I(""),W(""),K(["READY","TO","SPIN","..."])},800);return}const j=u.replace("！","!"),O=$i.find(L=>L.password.toLowerCase()===j);O?(A.includes(O.id)?(W("该日志已解锁。"),ke(O.id)):(E(O.id),V(O.title),setTimeout(()=>V(null),1500),W(""),ke(O.id)),I("")):W("鸡尾酒配方没10000个也有9000个，这么试是学不到真本事的")},G=()=>{if(le)return;_e(!0),je(L=>L+1);let u=0;const j=20,O=setInterval(()=>{K([Hh[Math.floor(Math.random()*Hh.length)],Bh[Math.floor(Math.random()*Bh.length)],Uh[Math.floor(Math.random()*Uh.length)],Vh[Math.floor(Math.random()*Vh.length)]]),u++,u>=j&&(clearInterval(O),_e(!1))},80)},oe=u=>u.split(/(\[IMAGE:[^\]]+\])/g).map((O,L)=>{const U=O.match(/\[IMAGE:([^\]]+)\]/);if(U){const de=U[1];return o.jsx("div",{className:"my-6 flex justify-center",children:o.jsx("img",{src:B(de),alt:"Decoration",className:"max-w-[200px] h-auto rounded-sm shadow-md border-2 border-stone-200 bg-white p-2"})},`img-${L}`)}return O.split(/__([^_]+)__/g).map((de,T)=>T%2===1?o.jsx("span",{className:"font-bold text-red-600 border-b-2 border-red-500/40 px-1 transform -rotate-2 inline-block",children:de},`${L}-${T}`):o.jsx("span",{children:de},`${L}-${T}`))}),ye=u=>{const{content:j}=u,O="💡 更新",L=j.split(O),U=L[0],J=L.length>1?L.slice(1).join(O):null,de=U.indexOf(`

`);let T="",X=U;if(de!==-1){const ee=U.substring(0,de).trim();/[0-9]/.test(ee)&&/[a-zA-Z]/.test(ee)&&(T=ee,X=U.substring(de).trim())}return o.jsxs(o.Fragment,{children:[T&&o.jsxs("div",{className:"mb-8 border border-stone-300 p-6 bg-[#fcfbf9] shadow-sm relative mx-2 text-center",children:[o.jsx("div",{className:"absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-2 text-[10px] font-mono tracking-widest text-stone-400 uppercase",children:"COCKTAIL RECIPE"}),(()=>{const ee=T.split(`
`),se=ee[0],Ie=ee.slice(1).join(`
`);return o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"mb-4",children:o.jsx("h3",{className:"text-xl md:text-2xl font-black text-stone-900 font-serif-film uppercase tracking-widest border-b-2 border-stone-900/10 pb-2 inline-block px-8 transform -rotate-1",children:oe(se)})}),o.jsx("div",{className:"text-sm md:text-base font-serif-film text-stone-800 whitespace-pre-wrap leading-loose tracking-wide",children:oe(Ie)})]})})()]}),o.jsx("div",{className:"text-base md:text-lg leading-relaxed text-indigo-900 whitespace-pre-wrap font-hand font-bold tracking-wide opacity-90 px-2",children:X.startsWith("（")&&X.indexOf("）")!==-1?(()=>{const ee=X.indexOf("）"),se=X.substring(1,ee),Ie=X.substring(ee+1),tt=se.split(/([，。；！])/).reduce(($e,We,Vt,Ca)=>(We.match(/[，。；！]/)&&Vt>0?$e[$e.length-1]+=We:We.trim()&&$e.push(We),$e),[]);return o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"mb-8 pl-4 border-l-2 border-indigo-300/50 italic text-indigo-700/80 font-serif text-sm md:text-base space-y-2",children:tt.map(($e,We)=>o.jsx("div",{children:$e.trim()},We))}),oe(Ie.trim())]})})():oe(X)}),J&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"my-6 border-t-2 border-dashed border-indigo-300 relative mx-2",children:o.jsx("span",{className:"absolute -top-3 left-0 bg-white pr-2 text-xs font-bold text-indigo-400 font-mono tracking-widest",children:"LATER ADDED"})}),o.jsxs("div",{className:"relative pl-4 border-l-4 border-indigo-900/20 mx-2",children:[o.jsx("h3",{className:"font-hand text-indigo-800 font-bold text-lg mb-2 flex items-center gap-2",children:"💡 更新:"}),o.jsx("div",{className:"text-sm md:text-base leading-relaxed text-indigo-900/90 whitespace-pre-wrap font-hand tracking-wide font-bold",children:oe(J.startsWith("：")?J.substring(1):J)})]})]}),u.attachments&&u.attachments.length>0&&u.attachmentType==="novel"&&o.jsxs("button",{onClick:()=>{Oe(!0),De(0)},className:"mt-8 w-full relative group cursor-pointer text-left focus:outline-none",children:[o.jsx("div",{className:"absolute inset-0 bg-stone-800 shadow-md transform rotate-1 rounded-sm translate-y-1 translate-x-1"}),o.jsxs("div",{className:"relative bg-[#f5f5f0] border-l-4 border-stone-800 p-4 h-32 flex items-center justify-between overflow-hidden hover:bg-white transition-colors border border-stone-300",children:[o.jsxs("div",{className:"flex flex-col z-10",children:[o.jsx("span",{className:"font-serif text-xl text-stone-900 tracking-widest font-black uppercase mb-1",children:u.title}),o.jsx("span",{className:"text-xs font-sans text-stone-500 font-normal",children:"Scanned Document • PDF Source"})]}),o.jsxs("div",{className:"flex items-center gap-2",children:[o.jsx("span",{className:"text-xs font-mono font-bold text-stone-400 uppercase tracking-widest group-hover:text-stone-900 transition-colors",children:"READ ATTACHMENT"}),o.jsx("div",{className:"w-8 h-8 rounded-full border border-stone-300 flex items-center justify-center group-hover:bg-stone-900 group-hover:text-white transition-colors",children:"↗"})]}),o.jsx("div",{className:"absolute right-0 top-0 w-32 h-full bg-gradient-to-l from-[#f5f5f0] to-transparent pointer-events-none"})]})]})]})},d=Le?$i.find(u=>u.id===Le):null;return o.jsxs("div",{className:"flex-1 bg-stone-200 flex flex-col relative overflow-hidden text-stone-800 font-sans",children:[o.jsxs("div",{className:"bg-sky-700 text-white p-4 border-b-4 border-sky-900 flex justify-between items-center shadow-lg relative z-20",children:[o.jsxs("div",{children:[o.jsx("h1",{className:"text-xl font-bold tracking-tight",children:ne("blogTitle",N)}),o.jsx("p",{className:"text-xs text-sky-200 mt-1",children:ne("blogSubtitle",N)})]}),o.jsxs("div",{className:"flex items-center gap-3",children:[C&&o.jsx("button",{onClick:C,className:`text-[10px] px-2 py-1 rounded border transition-colors ${z?"bg-stone-600 border-stone-500 text-stone-300 hover:bg-stone-500":"bg-sky-600 border-sky-400 text-white hover:bg-sky-500"}`,children:ne(z?"effectsOff":"effectsOn",N)}),o.jsx("button",{onClick:m,className:"text-xs bg-sky-800 hover:bg-sky-600 px-3 py-1 rounded border border-sky-400",children:ne("logout",N)})]})]}),o.jsx(Xh,{text:"都出来写博客了，怎么还要这样藏来藏去，看来我要在其他地方获得一些酒名的线索才能偷窥他的树洞。这个闪来闪去的特效又是什么，有没有考虑过读者的眼睛，算他有良心还放了个可以关闭的按钮。",isVisible:ze,onClose:Me}),x&&o.jsx("div",{className:"absolute inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-in fade-in duration-300 pointer-events-none",children:o.jsxs("div",{className:"bg-white p-8 border-4 border-green-600 shadow-2xl transform rotate-3 flex flex-col items-center",children:[o.jsx("div",{className:"text-green-600 font-bold border-2 border-green-600 rounded-full w-16 h-16 flex items-center justify-center text-3xl mb-4 animate-bounce",children:"✓"}),o.jsx("h2",{className:"text-2xl font-black text-stone-800 uppercase tracking-widest",children:"New Entry"}),o.jsxs("p",{className:"text-stone-600 mt-2 font-serif text-lg italic",children:['"',x,'"']}),o.jsx("p",{className:"text-xs text-stone-400 mt-4 font-mono",children:"UNLOCKED"})]})}),o.jsxs("div",{className:"flex-1 overflow-y-auto p-4 md:p-8 bg-stone-200 relative z-10",children:[Le&&o.jsx("button",{onClick:()=>ke(null),className:"sticky top-0 left-0 ml-auto mb-4 text-[10px] sm:text-xs font-mono text-stone-500 hover:text-sky-600 flex items-center gap-1 bg-white/95 backdrop-blur-sm px-2 sm:px-3 py-1 sm:py-2 rounded border border-stone-300 shadow-lg transition-all hover:shadow-xl hover:border-sky-400 z-50 w-fit",children:ne("backToIndex",N)}),!d&&o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/grid-noise.png')] opacity-10 pointer-events-none z-0"}),o.jsx("div",{className:"max-w-2xl mx-auto space-y-8 pb-20 relative z-10",children:ie?o.jsxs("div",{className:"animate-in zoom-in-95 duration-500 relative",children:[o.jsx("button",{onClick:()=>P(!1),className:"mb-6 text-xs font-mono font-bold text-stone-500 hover:text-sky-700 flex items-center gap-1 uppercase tracking-widest transition-colors",children:"← Back to Blog"}),o.jsxs("div",{className:"relative p-8 bg-[#f5f0e6] rounded-sm border-2 border-stone-800 shadow-[4px_4px_0px_rgba(40,30,20,1)] max-w-3xl mx-auto rotate-1",children:[o.jsx("div",{className:"absolute inset-0 bg-[linear-gradient(#00000008_1px,transparent_1px),linear-gradient(90deg,#00000008_1px,transparent_1px)] bg-[size:20px_20px] pointer-events-none rounded-sm overflow-hidden"}),o.jsx("div",{className:"absolute -top-10 -right-10 w-40 h-40 border-[16px] border-[#8b451310] rounded-full blur-[2px] pointer-events-none"}),o.jsx("div",{className:"absolute -top-3 left-1/2 -translate-x-1/2 w-32 h-8 bg-amber-100/80 backdrop-blur-sm shadow-sm rotate-1 z-10 box-decoration-clone",children:o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/noise-lines.png')] opacity-20"})}),o.jsx("style",{children:`
                                ...
                                `}),o.jsxs("div",{className:"text-center mb-10 relative z-10",children:[le&&o.jsx("div",{className:"absolute inset-0 bg-white pointer-events-none animate-flash-overlay z-50 rounded-lg"}),o.jsx("h2",{className:"font-serif-film text-4xl text-stone-900 mb-4 tracking-tight",style:{textShadow:"2px 2px 0px rgba(0,0,0,0.1)"},children:"Dram Elysium"}),o.jsx("div",{className:"relative inline-block",children:o.jsxs("p",{className:"font-hand text-stone-600 text-sm md:text-base leading-relaxed max-w-lg mx-auto bg-white/60 p-4 border-2 border-stone-800 hand-drawn-border shadow-sm transform -rotate-1",children:['"',ne("dramElysiumIntro",N),'"',o.jsx("br",{}),o.jsx("span",{className:"block mt-2 font-bold text-stone-800 text-right",children:ne("dramElysiumSignature",N)})]})})]}),o.jsx("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-3 mb-12 px-4 relative z-10",children:[0,1,2,3].map(u=>o.jsxs("div",{className:"bg-white border-2 border-stone-800 p-2 flex flex-col items-center justify-center h-28 relative shadow-[3px_3px_0px_#2c2c2c] hand-drawn-border transition-transform hover:-translate-y-1 hover:shadow-[4px_4px_0px_#2c2c2c]",children:[o.jsxs("div",{className:"absolute -top-3 left-1/2 -translate-x-1/2 bg-stone-800 text-white text-[9px] px-2 py-0.5 min-w-[50px] text-center transform rotate-1 rounded-sm",children:["ITEM #",u+1]}),o.jsx("span",{className:`
                                                font-hand text-lg md:text-xl text-stone-900 text-center leading-tight font-bold
                                                ${le?"opacity-40 blur-[1px]":""}
                                                transition-all duration-100
                                                break-all
                                            `,children:we[u]})]},u))}),o.jsx("div",{className:"flex justify-center -mb-12 relative z-30",children:o.jsxs("button",{onClick:G,disabled:le,className:`
                                            group relative w-24 h-24 md:w-32 md:h-32
                                            transition-all duration-200 
                                            ${le?"animate-shake-mixer cursor-default":"hover:scale-105 active:scale-95 cursor-pointer"}
                                        `,children:[o.jsx("img",{src:B("/assets/shaker_cute.png"),alt:"Shake for Luck",className:"w-full h-full object-contain drop-shadow-md opacity-90 contrast-125 sepia-[.2]"}),o.jsx("div",{className:`
                                            ...
                                            ${le?"opacity-100 scale-105 rotate-12":"opacity-0 group-hover:opacity-100 group-hover:-translate-y-2"}
                                        `,children:o.jsx("span",{className:"font-hand text-stone-800 text-xs font-bold block whitespace-nowrap",children:le?"Mixing...":"Shake me!"})})]})}),o.jsx("div",{className:`absolute bottom-6 right-6 w-14 h-14 md:w-20 md:h-20 transition-transform duration-200 z-40 ${le?"animate-shake-logo":"hover:rotate-12"}`,children:o.jsx("img",{src:B("/assets/dram_logo.png"),alt:"Dram Logo",className:"w-full h-full object-contain opacity-90 drop-shadow-sm"})})]})]}):d?o.jsxs("div",{className:"relative group no-caret",children:[o.jsxs("div",{className:"bg-white border border-stone-300 p-6 shadow-sm relative z-20",children:[o.jsx("div",{className:"border-b border-dashed border-stone-300 pb-2 mb-4",children:o.jsx("h2",{className:"text-lg font-bold text-sky-800 font-mono",children:d.title})}),ye(d),o.jsxs("div",{className:"mt-6 pt-4 border-t border-stone-100 text-[10px] text-stone-400 text-right font-mono",children:[ne("postedBy",N)," Apple"]})]}),d.stickyNote&&o.jsxs("div",{className:`
...
`).map((u,j)=>o.jsxs("div",{className:"relative",children:[o.jsx("p",{className:`relative z-10 ${j===4?"font-bold text-stone-900":""}`,children:u}),j===4&&o.jsx("div",{className:"absolute -inset-2 pointer-events-none select-none",children:o.jsx("svg",{className:"w-full h-full overflow-visible opacity-80",viewBox:"0 0 300 60",preserveAspectRatio:"none",children:o.jsx("path",{d:"M5,30 Q30,5 150,5 Q270,5 290,30 Q300,55 150,55 Q10,55 5,30 M10,32 Q50,60 120,58",fill:"none",stroke:"#c2410c",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",vectorEffect:"non-scaling-stroke"})})})]},j))})]})]}):o.jsxs("div",{className:`space-y-8 animate-in slide-in-from-left-4 duration-300 ${pe?"opacity-0 scale-95 transition-all duration-700":""}`,children:[_&&o.jsxs("div",{className:"relative transform rotate-[-1deg] mb-8",children:[o.jsx("div",{className:"absolute top-1 left-1 w-full h-full bg-black/10 rounded-sm"}),o.jsxs("div",{className:"relative bg-[#f0eadd] p-6 border border-[#d6cbb8] shadow-md rounded-sm",children:[o.jsx("div",{className:"absolute -top-3 left-1/2 -translate-x-1/2 w-32 h-6 bg-red-900/10 blur-[1px] transform rotate-1"}),o.jsxs("div",{className:"border-b border-stone-300 pb-2 mb-2 flex justify-between",children:[o.jsxs("span",{className:"text-xs font-mono text-stone-500 uppercase tracking-widest",children:[ne("readme",N),".TXT"]}),o.jsx("span",{className:"text-xs font-mono text-stone-400",children:"2020.05.20"})]}),o.jsx("p",{className:"font-hand text-lg text-stone-800 leading-relaxed font-bold",children:_.content})]})]}),o.jsxs("div",{className:"bg-stone-900 border-2 border-stone-700 p-4 shadow-md rounded-sm caret-slow",children:[o.jsx("label",{className:"block text-xs font-bold text-stone-400 uppercase mb-2",children:ne("searchLabel",N)}),o.jsxs("div",{className:"flex gap-2",children:[o.jsx("input",{type:"text",value:q,onChange:u=>I(u.target.value),placeholder:ne("searchPlaceholder",N),className:`flex-1 bg-stone-800 text-stone-200 border border-stone-600 p-2 text-sm focus:outline-none focus:border-sky-500 font-mono ${pe?"border-amber-400 bg-amber-50 text-amber-600 shadow-[0_0_30px_rgba(251,191,36,0.4)] scale-105 transition-all duration-300":""}`,onKeyDown:u=>u.key==="Enter"&&D()}),o.jsx("button",{onClick:D,className:"bg-stone-200 border border-stone-400 px-4 text-xs font-bold hover:bg-stone-300 text-stone-700 transition-colors",children:ne("unlock",N)})]}),R&&o.jsx("p",{className:"text-xs text-red-400 mt-2",children:R})]}),o.jsxs("div",{children:[o.jsxs("h3",{className:"text-stone-500 font-mono text-xs uppercase tracking-widest mb-4 border-b border-stone-300 pb-2",children:[ne("archivedEntries",N)," (",A.filter(u=>u!=="intro").length,")"]}),o.jsx("div",{className:"grid gap-3",children:$i.map(u=>!A.includes(u.id)||u.id==="intro"?null:o.jsxs("button",{onClick:()=>ke(u.id),className:"bg-white border border-stone-300 p-4 shadow-sm hover:shadow-md hover:border-sky-400 transition-all text-left flex items-center group relative overflow-hidden",children:[o.jsx("div",{className:"absolute left-0 top-0 bottom-0 w-1 bg-stone-300 group-hover:bg-sky-500 transition-colors"}),o.jsx("div",{className:"w-10 h-10 bg-stone-100 flex items-center justify-center mr-4 rounded-sm border border-stone-200",children:o.jsx("span",{className:"text-xl",children:"📄"})}),o.jsxs("div",{children:[o.jsx("h4",{className:"font-bold text-stone-700 group-hover:text-sky-700 font-mono",children:u.title}),o.jsx("p",{className:"text-[10px] text-stone-400 font-mono uppercase",children:ne("archiveDateLabel",N)})]}),o.jsx("span",{className:"ml-auto text-stone-300 group-hover:text-sky-500 font-mono text-xs",children:"OPEN →"})]},u.id))})]})]})})]}),Be&&(d==null?void 0:d.attachments)&&o.jsx("div",{className:"fixed inset-0 z-[100] bg-black/95 flex flex-col items-center justify-center p-4 backdrop-blur-md animate-in fade-in duration-300",onClick:()=>Oe(!1),children:o.jsxs("div",{className:"relative w-full max-w-4xl max-h-full flex flex-col items-center my-8",onClick:u=>u.stopPropagation(),children:[o.jsxs("div",{className:"relative w-full max-h-[85vh] shadow-2xl bg-white rounded-sm flex flex-col md:flex-row overflow-hidden",children:[o.jsx("div",{className:"hidden md:flex flex-none w-16 items-center justify-center bg-stone-50 border-r border-stone-100 z-10 cursor-pointer hover:bg-stone-100 transition-colors",onClick:u=>{u.stopPropagation(),ce>0&&De(j=>j-1)},children:ce>0?o.jsx("button",{className:"p-4 text-stone-400 hover:text-stone-800 transition-colors","aria-label":"Previous Page",children:o.jsx("span",{className:"text-4xl font-light leading-none",children:"←"})}):o.jsx("div",{className:"w-16"})}),o.jsxs("div",{className:"relative flex-1 overflow-y-auto p-8 md:p-16 scrollbar-thin scrollbar-thumb-stone-300 scrollbar-track-transparent",children:[o.jsxs("button",{onClick:()=>Oe(!1),className:"absolute top-4 right-6 z-20 text-stone-300 hover:text-stone-500 font-serif italic text-sm transition-colors flex items-center gap-1",children:[o.jsx("span",{children:"CLOSE"})," ✕"]}),d.attachments[ce].endsWith(".png")||d.attachments[ce].endsWith(".jpg")?o.jsx("img",{src:B(d.attachments[ce]),alt:`Page ${ce+1}`,className:"w-full h-auto block rounded-sm opacity-90 transition-opacity duration-500"}):o.jsxs("div",{className:"max-w-2xl mx-auto font-serif text-stone-800 leading-relaxed text-lg whitespace-pre-wrap pb-12",children:[o.jsxs("div",{className:"flex justify-between items-center border-b border-stone-200 pb-2 mb-8",children:[o.jsxs("h3",{className:"text-sm font-sans text-stone-400 uppercase tracking-widest",children:["Page ",ce+1]}),o.jsxs("span",{className:"text-xs font-mono text-stone-300",children:[d.attachments[ce].length," chars"]})]}),d.attachments[ce].includes("「所以，你找到真相了吗？」")?o.jsxs(o.Fragment,{children:[d.attachments[ce].replace("「所以，你找到真相了吗？」",""),o.jsxs("div",{className:"flex items-center gap-4 mt-8 justify-end",children:[o.jsx("span",{className:"font-serif italic",children:"「所以，你找到真相了吗？」"}),o.jsx("img",{src:B("/hunstler_logo.jpg"),alt:"Hunstler Klub",className:"w-16 h-auto opacity-80 hover:opacity-100 transition-opacity grayscale hover:grayscale-0"})]})]}):d.attachments[ce]]}),o.jsxs("div",{className:"flex md:hidden justify-between mt-12 pt-8 border-t border-stone-100",children:[o.jsx("button",{disabled:ce===0,onClick:u=>{u.stopPropagation(),De(j=>j-1)},className:`px-4 py-2 rounded-sm border ${ce===0?"border-stone-100 text-stone-200":"border-stone-300 text-stone-600"}`,children:"Previous"}),o.jsx("button",{disabled:ce===d.attachments.length-1,onClick:u=>{u.stopPropagation(),De(j=>j+1)},className:`px-4 py-2 rounded-sm border ${ce===d.attachments.length-1?"border-stone-100 text-stone-200":"border-stone-800 bg-stone-800 text-white"}`,children:"Next"})]})]}),o.jsx("div",{className:"hidden md:flex flex-none w-16 items-center justify-center bg-stone-50 border-l border-stone-100 z-10 cursor-pointer hover:bg-stone-100 transition-colors",onClick:u=>{u.stopPropagation(),ce<d.attachments.length-1&&De(j=>j+1)},children:ce<d.attachments.length-1?o.jsx("button",{className:"p-4 text-stone-400 hover:text-stone-800 transition-colors","aria-label":"Next Page",children:o.jsx("span",{className:"text-4xl font-light leading-none",children:"→"})}):o.jsx("div",{className:"w-16"})})]}),o.jsxs("div",{className:"mt-4 flex flex-col items-center gap-2",children:[o.jsx("div",{className:"flex gap-2",children:d.attachments.map((u,j)=>o.jsx("div",{className:`w-1.5 h-1.5 rounded-full transition-all duration-300 ${j===ce?"bg-stone-200 scale-125":"bg-stone-700"}`},j))}),o.jsxs("div",{className:"text-xs font-mono text-stone-500 uppercase tracking-[0.2em] flex items-center gap-2",children:[o.jsxs("span",{children:["ITEM ",ce+1,".",d.attachments.length]}),o.jsx("span",{className:"w-8 h-[1px] bg-stone-700"}),o.jsx("span",{children:"SCANNED_DOC"})]})]})]})})]})},Jp=({film:m,onBack:A})=>{const E=Array.from({length:16}),f=Array.isArray(m.contentImage)?m.contentImage:[m.contentImage,m.contentImage],z=f[0],C=f[1]||f[0],[N,q]=M.useState(null);return o.jsxs("div",{className:"flex-1 bg-black flex flex-col relative p-2 sm:p-4 overflow-hidden",children:[o.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(40,40,40,1)_0%,rgba(0,0,0,1)_90%)] z-0"}),o.jsx("div",{className:"absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] z-0 pointer-events-none animate-pulse"}),o.jsx("button",{onClick:A,className:"absolute top-3 sm:top-6 left-3 sm:left-6 text-stone-500 hover:text-white z-30 text-[10px] sm:text-xs font-mono tracking-widest uppercase",children:"[ EJECT ]"}),o.jsx("div",{className:"flex-1 flex items-center justify-center relative z-10 perspective-1000",children:o.jsxs("div",{className:"relative bg-black border-y-4 sm:border-y-8 border-black shadow-[0_0_50px_rgba(255,200,150,0.1)] transform rotate-1 scale-90 sm:scale-100 md:scale-110 lg:scale-125",children:[o.jsx("div",{className:"absolute top-1/2 left-0 right-0 h-40 -translate-y-1/2 bg-amber-100/10 blur-xl"}),o.jsx("div",{className:"h-6 flex justify-between items-center px-2 gap-2 bg-[#1a1a1a] border-b border-stone-800",children:E.map((I,x)=>o.jsx("div",{className:"w-3 h-4 bg-black/80 rounded-[2px] shadow-[inset_0_1px_2px_rgba(255,255,255,0.1)]"},`top-${x}`))}),o.jsxs("div",{className:"flex gap-[2px] bg-black py-4 px-4 overflow-hidden relative",children:[o.jsxs("div",{className:"relative w-48 sm:w-64 md:w-80 aspect-[4/3] bg-black overflow-hidden border border-stone-800/50 cursor-pointer hover:border-amber-500/50 transition-colors",onClick:()=>q(z),children:[o.jsx("img",{src:z,alt:"Frame 1",className:`w-full h-full object-cover opacity-90 filter sepia-[0.4] contrast-[1.1] brightness-[0.9] ${m.id==="reel_06"?"saturate-[0.7]":""} ${["reel_08","reel_09"].includes(m.id)?"brightness-[0.95] contrast-[1.2] saturate-[0.8] sepia-[0.65] blur-[0.6px]":""}`}),m.id==="reel_06"&&o.jsx("div",{className:"absolute inset-0 pointer-events-none z-10 overflow-hidden",children:o.jsx("div",{className:"absolute inset-0 backdrop-blur-[1px]",style:{maskImage:"radial-gradient(circle at 35% 75%, transparent 25%, black 80%)",WebkitMaskImage:"radial-gradient(circle at 35% 75%, transparent 25%, black 80%)"}})}),["reel_08","reel_09"].includes(m.id)&&o.jsx("div",{className:"absolute inset-0 pointer-events-none z-20 bg-[radial-gradient(circle,transparent_35%,rgba(0,0,0,0.5)_100%)]"}),o.jsx("span",{className:"absolute bottom-1 right-2 text-[8px] font-mono text-amber-500/50 transform -scale-x-100",children:"8mm 2401"}),o.jsx("div",{className:"absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity bg-black/50 pointer-events-none",children:o.jsx("span",{className:"text-white text-xs font-mono",children:"[ CLICK TO ZOOM ]"})})]}),o.jsxs("div",{className:"relative w-48 sm:w-64 md:w-80 aspect-[4/3] bg-black overflow-hidden border border-stone-800/50 cursor-pointer hover:border-amber-500/50 transition-colors",onClick:()=>q(C),children:[o.jsx("img",{src:C,alt:"Frame 2",className:`w-full h-full object-cover opacity-90 filter sepia-[0.4] contrast-[1.1] brightness-[0.9] ${m.id==="reel_06"?"saturate-[0.7]":""} ${["reel_08","reel_09"].includes(m.id)?"brightness-[0.95] contrast-[1.2] saturate-[0.8] sepia-[0.65] blur-[0.6px]":""}`}),m.id==="reel_06"&&o.jsx("div",{className:"absolute inset-0 pointer-events-none z-10 overflow-hidden",children:o.jsx("div",{className:"absolute inset-0 backdrop-blur-[1px]",style:{maskImage:"radial-gradient(circle at 35% 75%, transparent 25%, black 80%)",WebkitMaskImage:"radial-gradient(circle at 35% 75%, transparent 25%, black 80%)"}})}),["reel_08","reel_09"].includes(m.id)&&o.jsx("div",{className:"absolute inset-0 pointer-events-none z-20 bg-[radial-gradient(circle,transparent_35%,rgba(0,0,0,0.5)_100%)]"}),o.jsx("div",{className:"absolute inset-0 border-l border-white/10 mx-10"}),o.jsx("span",{className:"absolute bottom-1 right-2 text-[8px] font-mono text-amber-500/50 transform -scale-x-100",children:"8mm 2402"}),o.jsx("div",{className:"absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity bg-black/50 pointer-events-none",children:o.jsx("span",{className:"text-white text-xs font-mono",children:"[ CLICK TO ZOOM ]"})})]}),o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/noise-lines.png')] opacity-30 pointer-events-none mix-blend-overlay"})]}),o.jsx("div",{className:"h-6 flex justify-between items-center px-2 gap-2 bg-[#1a1a1a] border-t border-stone-800",children:E.map((I,x)=>o.jsx("div",{className:"w-3 h-4 bg-black/80 rounded-[2px] shadow-[inset_0_-1px_2px_rgba(255,255,255,0.1)]"},`bottom-${x}`))})]})}),o.jsx("div",{className:"absolute bottom-12 left-0 right-0 text-center z-30 px-8",children:o.jsxs("div",{className:"inline-block relative",children:[o.jsx("div",{className:"absolute -inset-4 bg-black/90 blur-md"}),o.jsx("p",{className:"relative text-stone-200 font-serif-film text-xs sm:text-sm md:text-lg tracking-wide leading-relaxed max-w-2xl cursor-text select-text px-2",style:{userSelect:"text",WebkitUserSelect:"text"},children:m.contentDesc})]})}),o.jsx("style",{jsx:!0,children:`
      ...
      `}),N&&o.jsxs("div",{className:"fixed inset-0 z-50 bg-black/95 flex items-center justify-center p-4 cursor-zoom-out animate-in fade-in duration-200",onClick:()=>q(null),children:[o.jsx("button",{className:"absolute top-6 right-6 text-stone-400 hover:text-white text-xs font-mono tracking-widest uppercase z-10 transition-colors",onClick:()=>q(null),children:"[ CLOSE ]"}),o.jsxs("div",{className:"relative max-w-[90vw] max-h-[90vh] flex items-center justify-center",children:[o.jsx("img",{src:N,alt:"Zoomed frame",className:"max-w-full max-h-[90vh] object-contain shadow-2xl",onClick:I=>I.stopPropagation()}),o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/noise-lines.png')] opacity-20 pointer-events-none mix-blend-overlay"})]}),o.jsx("div",{className:"absolute bottom-6 left-0 right-0 text-center",children:o.jsx("span",{className:"text-stone-500 text-xs font-mono tracking-wide",children:"[ CLICK ANYWHERE TO CLOSE ]"})})]})]})},Wp=({film:m,onBack:A})=>{const E=Array.isArray(m.contentImage)?m.contentImage:[m.contentImage],[f,z]=M.useState(null);return o.jsxs("div",{className:"flex-1 bg-[#050505] flex flex-col relative p-8 overflow-hidden",children:[o.jsx("div",{className:"absolute inset-0 opacity-40 bg-[url('https://www.transparenttextures.com/patterns/dark-leather.png')] z-0 pointer-events-none"}),o.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-black/0 to-black/60 z-0 pointer-events-none"}),o.jsxs("div",{className:"relative z-30 flex justify-between items-center mb-8 px-4",children:[o.jsx("button",{onClick:A,className:"text-stone-500 hover:text-white text-xs font-mono tracking-widest uppercase transition-colors",children:"[ CLOSE ARCHIVE ]"}),o.jsx("div",{className:"text-stone-600 font-mono text-[10px] tracking-[0.2em] uppercase",children:"Batch 00 • Shredded Fragments • Processed Oct 1984"})]}),o.jsx("div",{className:"flex-1 relative z-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 overflow-y-auto px-4 scrollbar-hide pb-32",children:E.map((C,N)=>o.jsxs("div",{onClick:()=>z(N),className:`group relative aspect-[4/3] bg-black shadow-2xl transition-all duration-500 hover:scale-105 hover:z-40 
            ...
            `,style:{transform:`rotate(${N%5-2}deg) translate(${Math.sin(N)*5}px, ${Math.cos(N)*10}px)`,zIndex:10+N%5},children:[o.jsx("img",{src:C||"",alt:`Fragment ${N+1}`,className:"w-full h-full object-cover filter sepia-[0.5] contrast-[1.2] brightness-[0.8] saturate-[0.7] blur-[0.4px] opacity-80 group-hover:opacity-100 group-hover:brightness-100 group-hover:blur-none transition-all duration-300"}),(N===2||N===6)&&o.jsx("div",{className:"absolute top-[8%] right-[12%] w-[25%] h-[30%] pointer-events-none z-30 overflow-hidden opacity-25 mix-blend-overlay group-hover:opacity-32 transition-opacity duration-700",children:o.jsx("img",{src:B("/assets/ghost_overlay.png"),alt:"",className:"w-full h-full object-contain opacity-50",style:{filter:"blur(3px) contrast(0.6) brightness(1.5) grayscale(0.3)"}})}),(N===2||N===6)&&o.jsxs("div",{className:"absolute inset-0 pointer-events-none z-40 overflow-hidden",children:[o.jsx("div",{className:"absolute left-[20%] top-0 bottom-0 w-[1px] bg-white/20 blur-[0.5px]"}),o.jsx("div",{className:"absolute left-[22%] top-0 bottom-0 w-[0.5px] bg-white/10"}),o.jsx("div",{className:"absolute right-[35%] top-0 bottom-0 w-[1px] bg-stone-200/20 rotate-1"})]}),o.jsx("div",{className:"absolute inset-0 pointer-events-none z-20 bg-[radial-gradient(circle,transparent_40%,rgba(0,0,0,0.6)_100%)]"}),o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/noise-lines.png')] opacity-30 pointer-events-none mix-blend-overlay"}),o.jsx("div",{className:"absolute inset-0 border-[8px] border-black/40 pointer-events-none box-border"}),o.jsx("div",{className:"absolute bottom-2 left-2 bg-black/60 px-2 py-0.5 rounded backdrop-blur-sm border border-stone-800/50",children:o.jsxs("span",{className:"text-[8px] font-mono text-stone-400 uppercase tracking-tighter",children:["FRA_",N.toString().padStart(2,"0")]})})]},`${m.id}-fragment-${N}`))}),o.jsx("div",{className:"absolute bottom-0 left-0 right-0 p-8 z-30 pointer-events-none",children:o.jsx("div",{className:"max-w-2xl mx-auto",children:o.jsxs("div",{className:"bg-black/80 backdrop-blur-lg p-6 border border-stone-800/50 shadow-2xl transform -rotate-1",children:[o.jsxs("h2",{className:"text-stone-500 font-mono text-[10px] uppercase tracking-widest mb-2 border-b border-stone-800 pb-2 flex justify-between",children:[o.jsx("span",{children:"Investigation Note"}),o.jsx("span",{className:"opacity-50",children:"Confidential"})]}),o.jsx("p",{className:"text-stone-300 font-serif text-sm italic leading-relaxed",children:m.contentDesc})]})})}),f!==null&&o.jsx("div",{className:"fixed inset-0 z-[100] bg-black/95 flex items-center justify-center p-8 md:p-16 backdrop-blur-sm cursor-zoom-out",onClick:()=>z(null),children:o.jsxs("div",{className:"relative max-w-5xl w-full aspect-[4/3] bg-black shadow-[0_0_100px_rgba(0,0,0,0.5)] border-2 border-stone-800 overflow-hidden",onClick:C=>C.stopPropagation(),children:[o.jsx("img",{src:E[f],alt:`Zoomed Fragment ${f}`,className:"w-full h-full object-contain filter sepia-[0.3] contrast-[1.1] brightness-[0.9] saturate-[0.8]"}),(f===2||f===6)&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"absolute top-[10%] right-[15%] w-[22%] h-[28%] pointer-events-none z-30 opacity-28 mix-blend-overlay",children:o.jsx("img",{src:B("/assets/ghost_overlay.png"),alt:"",className:"w-full h-full object-contain opacity-55",style:{filter:"blur(3.5px) contrast(0.5) brightness(1.6) grayscale(0.4)"}})}),o.jsxs("div",{className:"absolute inset-0 pointer-events-none z-40",children:[o.jsx("div",{className:"absolute left-[20%] top-0 bottom-0 w-[1.5px] bg-white/20 blur-[1px]"}),o.jsx("div",{className:"absolute right-[35%] top-0 bottom-0 w-[1px] bg-stone-200/20 rotate-1"})]})]}),o.jsx("div",{className:"absolute inset-0 pointer-events-none z-20 bg-[radial-gradient(circle,transparent_50%,rgba(0,0,0,0.4)_100%)]"}),o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/noise-lines.png')] opacity-20 pointer-events-none mix-blend-overlay"}),o.jsx("button",{className:"absolute top-4 right-4 text-stone-500 hover:text-white transition-colors",onClick:()=>z(null),children:o.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-8 w-8",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:o.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1,d:"M6 18L18 6M6 6l12 12"})})}),o.jsxs("div",{className:"absolute bottom-4 left-6 font-mono text-[10px] text-stone-500 tracking-[0.3em] uppercase",children:["FRAGMENT_",f.toString().padStart(2,"0")," // ENLARGED_VIEW"]})]})})]})},Fp=({type:m,className:A})=>{const E={stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",fill:"none",className:A};switch(m){case 0:return o.jsxs("svg",{viewBox:"0 0 24 24",...E,children:[o.jsx("path",{d:"M12 21v-6"}),o.jsx("path",{d:"M8 21h8"}),o.jsx("path",{d:"M12 15l-3.5-9h7l-3.5 9"}),o.jsx("path",{d:"M9 6h6",opacity:"0.5"})]});case 1:return o.jsxs("svg",{viewBox:"0 0 24 24",...E,children:[o.jsx("path",{d:"M12 21v-9"}),o.jsx("path",{d:"M8 21h8"}),o.jsx("path",{d:"M3 5l9 7 9-7H3z"}),o.jsx("path",{d:"M6 5l6 5 6-5",opacity:"0.3"})]});case 2:return o.jsxs("svg",{viewBox:"0 0 24 24",...E,children:[o.jsx("path",{d:"M7 6l1.5 13h7l1.5-13H7z"}),o.jsx("path",{d:"M5 21h14",strokeWidth:"1",strokeDasharray:"1 2"}),o.jsx("path",{d:"M8 10h8",opacity:"0.3"}),o.jsx("path",{d:"M9 15h6",opacity:"0.3"})]});case 3:return o.jsxs("svg",{viewBox:"0 0 24 24",...E,children:[o.jsx("path",{d:"M12 21v-8"}),o.jsx("path",{d:"M8 21h8"}),o.jsx("path",{d:"M12 13c-2.5 0-4.5-1.5-4.5-4V5h9v4c0 2.5-2 4-4.5 4z"}),o.jsx("path",{d:"M8 5v2",opacity:"0.3"}),o.jsx("path",{d:"M16 5v2",opacity:"0.3"})]});case 4:return null;default:return null}},$p=({onBack:m,onSelectReel:A,unlockedReels:E,onUnlockReel:f})=>{const[z,C]=M.useState(1),[N,q]=M.useState([1,2,3,0]),[I,x]=M.useState(""),[V,R]=M.useState(!1),[W,Le]=M.useState(null);M.useEffect(()=>{x("");const ie=Pi.find(P=>P.reelNumber===z);ie&&E.includes(ie.id)&&q(ie.code)},[z,E]);const ke=ie=>{x(""),q(P=>{const pe=[...P],xe=z===0?5:4;return pe[ie]=(pe[ie]+1)%xe,pe})},ze=ie=>{x("");const P=Math.max(-3,Math.min(8,z+ie));C(P)},Je=()=>{R(!0),setTimeout(()=>{R(!1),Me()},800)},Me=()=>{const ie=Pi.find(P=>P.reelNumber===z&&JSON.stringify(P.code)===JSON.stringify(N));ie?(f(ie.id),A(ie)):N.every(P=>P===0)?x(`REEL #${String(z)}: 曝光过度，胶片全白。`):x("胶卷顺序错误，无法查看")};return o.jsxs("div",{className:"fixed inset-0 w-full h-full bg-[#101010] flex flex-col items-center justify-center overflow-hidden font-sans text-stone-300 perspective-1000",children:[o.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_center,#1a1a1a_0%,#000000_100%)]"}),o.jsx("div",{className:"absolute inset-0 opacity-[0.08] pointer-events-none bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] mix-blend-screen"}),o.jsxs("div",{className:"relative z-10 w-full h-full max-h-screen flex flex-col items-center justify-center p-4 gap-4",children:[o.jsxs("div",{className:"relative w-full max-w-[550px] h-auto max-h-[90vh] sm:max-h-[85vh] aspect-square shadow-2xl flex-shrink-0 group",children:[o.jsx("div",{className:"absolute -bottom-8 left-4 right-4 h-10 bg-black/90 blur-xl rounded-[50%] transform scale-y-50"}),o.jsxs("div",{className:`
                    ...
                    `,children:[o.jsx("div",{className:"absolute inset-0 opacity-40 mix-blend-multiply bg-[url('https://www.transparenttextures.com/patterns/asfalt-light.png')] pointer-events-none z-30"}),o.jsx("div",{className:"absolute inset-0 opacity-20 mix-blend-color-burn bg-[url('https://www.transparenttextures.com/patterns/cardboard.png')] pointer-events-none z-30"}),o.jsxs("div",{className:"absolute top-0 left-0 w-full h-[22%] bg-gradient-to-b from-[#252525] to-[#1a1a1a] px-6 flex flex-col justify-center border-b border-white/10 shadow-md z-10 relative overflow-hidden",children:[o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/asfalt-dark.png')] opacity-30 mix-blend-overlay pointer-events-none"}),o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/noise-dark.png')] opacity-40 mix-blend-soft-light pointer-events-none"}),o.jsx("div",{className:"absolute top-0 right-10 w-32 h-32 bg-white/10 blur-xl rounded-full mix-blend-overlay"}),o.jsx("div",{className:"absolute bottom-2 left-20 w-24 h-24 bg-white/8 blur-lg rounded-full mix-blend-overlay"}),o.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent mix-blend-overlay"}),o.jsxs("div",{className:"flex flex-row items-baseline gap-2 relative z-10 opacity-95",children:[o.jsx("span",{className:"text-[#C82015] font-black text-3xl md:text-5xl tracking-tighter leading-none mix-blend-screen opacity-90 blur-[0.3px]",children:"KODAK"}),o.jsx("span",{className:"text-[#e5e5e5] font-bold text-3xl md:text-5xl tracking-tight leading-none mix-blend-screen opacity-90 blur-[0.3px]",children:"VISION3"})]}),o.jsx("span",{className:"text-[#888] text-[8px] md:text-xs font-light tracking-wide mt-0.5 uppercase mix-blend-screen opacity-80",children:"Color Negative Film"})]}),o.jsxs("div",{className:"absolute top-[22%] bottom-0 left-0 w-8 bg-[#e5e5e5] flex flex-col items-center justify-end pb-2 border-r border-[#d49a24] z-10 hidden md:flex",children:[o.jsx("div",{className:"w-full h-full bg-[url('https://www.transparenttextures.com/patterns/cardboard.png')] opacity-20 mix-blend-multiply absolute inset-0"}),o.jsx("div",{className:"w-full h-16 bg-[repeating-linear-gradient(0deg,#111,#111_1px,transparent_1px,transparent_3px)] opacity-70 mb-4 mix-blend-multiply"}),o.jsx("span",{className:"text-[6px] text-stone-800 -rotate-90 origin-center whitespace-nowrap mt-4 font-mono font-bold opacity-80",children:"7203 052 014"})]}),o.jsxs("div",{className:"absolute top-[22%] bottom-0 left-2 sm:left-4 md:left-8 right-0 p-2 sm:p-3 md:p-6 flex flex-col relative z-20 h-[78%] pb-12 sm:pb-16",children:[o.jsx("div",{className:"absolute right-[15%] top-[20%] w-40 h-40 bg-[#6b4e0d] rounded-full blur-3xl opacity-[0.25] mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute left-[25%] bottom-[30%] w-32 h-32 bg-[#5a4108] rounded-full blur-2xl opacity-[0.30] mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute right-[40%] top-[40%] w-24 h-24 bg-[#4d3606] rounded-full blur-xl opacity-[0.28] mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute left-[10%] top-[60%] w-20 h-20 bg-[#7a5d0f] rounded-full blur-lg opacity-[0.35] mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-[#8b6914]/40 to-transparent opacity-60 mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute bottom-0 left-0 w-56 h-56 bg-gradient-to-tr from-[#6b4e0d]/35 to-transparent opacity-70 mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute top-[10%] right-[20%] w-32 h-2 bg-[#5a4108] rotate-45 blur-sm opacity-[0.40] mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute bottom-[25%] left-[30%] w-24 h-2 bg-[#4d3606] -rotate-12 blur-sm opacity-[0.38] mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute top-[50%] left-[15%] w-28 h-1.5 bg-[#6b4e0d] rotate-[-30deg] blur-sm opacity-[0.35] mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute right-[5%] bottom-[15%] w-16 h-16 bg-[#7a5d0f] rounded-full blur-md opacity-[0.32] mix-blend-multiply pointer-events-none z-0"}),o.jsx("div",{className:"absolute left-[50%] top-[10%] w-12 h-12 bg-[#5a4108] rounded-full blur-md opacity-[0.30] mix-blend-multiply pointer-events-none z-0"}),o.jsx("button",{onClick:m,className:"absolute top-0 right-0 border-2 sm:border-[3px] border-[#da291c] p-0.5 sm:p-1 rotate-3 hover:rotate-0 transition-transform cursor-pointer z-50 bg-yellow-500/10 hover:bg-yellow-500/20 shadow-md",children:o.jsx("div",{className:"border-[1.5px] sm:border-[2px] border-[#da291c] px-2 sm:px-4 py-0.5 sm:py-1 flex items-center justify-center",children:o.jsx("span",{className:"text-[#da291c] font-black text-[8px] sm:text-[10px] md:text-sm tracking-widest uppercase",children:"RETURN"})})}),Pi.find(ie=>ie.reelNumber===z&&E.includes(ie.id))&&o.jsx("div",{className:"absolute top-0 left-2 z-20 transform -rotate-6 transition-transform duration-300 origin-top-left",children:o.jsxs("div",{className:`
                                    ...
                                    `,children:[o.jsx("div",{className:"absolute top-0 left-0 right-0 h-[6px] bg-black/[0.03] pointer-events-none mix-blend-multiply"}),o.jsx("span",{className:"text-stone-800 font-hand font-bold text-[10px] tracking-widest uppercase relative z-10 opacity-90 leading-none",children:"OPEN"})]})}),o.jsxs("div",{className:"relative z-10 flex flex-col gap-0 mt-0 shrink-0",children:[o.jsx("h1",{className:"text-[#1a1a1a] font-black text-xl sm:text-2xl md:text-5xl tracking-tight leading-none drop-shadow-sm mix-blend-multiply opacity-90 blur-[0.4px]",children:"Super 8"}),o.jsxs("div",{className:"flex items-center gap-1 mt-1",children:[o.jsx("span",{className:"text-[#222] font-bold text-xs sm:text-sm md:text-xl tracking-tighter opacity-80 blur-[0.2px] mix-blend-multiply",children:"50D"}),o.jsxs("div",{className:"flex items-center gap-0.5 sm:gap-1 border-[1px] border-[#1a1a1a]/40 px-0.5 sm:px-1 py-0.5 transform -rotate-1 bg-[#d49a24]/20 z-50 relative shadow-sm hover:scale-105 transition-transform",children:[o.jsx("span",{className:"text-[6px] sm:text-[8px] font-mono font-bold text-[#111] uppercase spacing-wide",children:"BATCH"}),o.jsx("button",{onClick:()=>ze(-1),className:"text-[#000] hover:text-[#da291c] font-black text-[10px] sm:text-xs px-1 sm:px-1.5 cursor-pointer transition-colors",children:"<"}),o.jsx("span",{className:"text-sm sm:text-lg font-mono font-bold text-[#000] min-w-[1rem] sm:min-w-[1.2rem] text-center relative",children:String(z).padStart(2,"0")}),o.jsx("button",{onClick:()=>ze(1),className:"text-[#000] hover:text-[#da291c] font-black text-[10px] sm:text-xs px-1 sm:px-1.5 cursor-pointer transition-colors",children:">"})]})]}),o.jsx("span",{className:"text-[#222] font-bold text-sm sm:text-lg md:text-xl tracking-tighter opacity-80 blur-[0.2px] mix-blend-multiply",children:"7203"})]}),o.jsx("div",{className:"flex flex-wrap sm:flex-nowrap flex-shrink-0 items-center justify-start gap-1.5 sm:gap-2 md:gap-5 mt-1.5 sm:mt-2 relative z-50 pl-0.5 sm:pl-1 mix-blend-normal min-h-[60px] sm:min-h-[80px] w-full",children:N.map((ie,P)=>{const pe=Pi.find(xe=>xe.reelNumber===z&&E.includes(xe.id));return o.jsxs("button",{onClick:()=>!pe&&ke(P),disabled:!!pe,className:`
                                                ...
                                                ${pe?"cursor-default opacity-90":"transition-all transform hover:-translate-y-1 cursor-pointer"}
                                            `,children:[o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cardboard.png')] opacity-10 mix-blend-multiply pointer-events-none"}),o.jsx("div",{className:`w-5 h-5 sm:w-6 sm:h-6 md:w-10 md:h-10 text-stone-900 transition-colors relative z-50 ${W===P?"opacity-0":"opacity-100"}`,children:o.jsx(Fp,{type:ie})}),pe&&o.jsx("div",{className:"absolute top-1 right-1 w-2 h-2 rounded-full bg-[#1a1a1a]/50"}),W===P&&o.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:o.jsx("span",{className:"animate-spin text-stone-900 font-bold",children:"⟳"})}),o.jsxs("span",{className:"absolute bottom-0.5 right-0.5 sm:bottom-1 sm:right-1 text-[6px] sm:text-[8px] text-stone-500 font-mono z-10",children:["0",P+1]})]},P)})})]}),o.jsxs("div",{className:"absolute bottom-2 sm:bottom-4 left-3 sm:left-6 right-3 sm:right-6 flex justify-between items-end z-50 pointer-events-auto mix-blend-normal",children:[o.jsx("div",{className:"w-8 h-8 sm:w-10 sm:h-10 text-[#C82015] opacity-90 mix-blend-multiply",children:o.jsxs("svg",{viewBox:"0 0 100 100",fill:"currentColor",children:[o.jsx("path",{d:"M10 10 h15 v80 h-15 Z"}),o.jsx("path",{d:"M35 10 h15 l35 35 l-35 35 h-15 l35 -35 Z"})]})}),o.jsxs("button",{onClick:Je,disabled:V,className:`
                                ...
                                `,children:[o.jsx("span",{className:"relative z-10 drop-shadow-sm filter",children:V?"Running...":"INSPECT"}),o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/noise.png')] opacity-30 mix-blend-multiply pointer-events-none"})]})]})]}),o.jsx("div",{className:"absolute inset-0 border border-white/20 pointer-events-none mix-blend-overlay"})]}),o.jsx("div",{className:"h-10 flex items-center justify-center mt-6 px-4 text-center shrink-0",children:I&&o.jsx("div",{className:"transform rotate-1 border-l-4 border-[#C82015] bg-[#222] px-4 py-2 shadow-2xl",children:o.jsx("span",{className:"text-stone-300 text-xs font-mono font-bold tracking-tight",children:I})})})]})]})},Pp=({onComplete:m})=>{const[A,E]=M.useState(0),[f,z]=M.useState(1),C=M.useRef(!1),{language:N}=en(),q=[{content:o.jsxs(o.Fragment,{children:[o.jsx("p",{children:ne("introSlide1Line1",N)}),o.jsx("p",{className:"mt-8",children:ne("introSlide1Line2",N)})]})},{content:o.jsxs(o.Fragment,{children:[o.jsx("p",{children:ne("introSlide2Line1",N)}),o.jsx("p",{className:"mt-8",children:ne("introSlide2Line2",N)}),o.jsx("p",{className:"mt-8",children:ne("introSlide2Line3",N)})]})},{content:o.jsxs(o.Fragment,{children:[o.jsx("p",{className:"text-stone-400 text-base mb-8 tracking-widest uppercase",children:ne("introSlide3Header",N)}),o.jsxs("ul",{className:"space-y-4 text-stone-300 text-lg text-left inline-block list-none border-l-2 border-stone-800 pl-8 font-mono-film",children:[o.jsx("li",{children:ne("introSlide3Item1",N)}),o.jsx("li",{children:ne("introSlide3Item2",N)}),o.jsx("li",{children:ne("introSlide3Item3",N)})]})]})},{content:o.jsxs(o.Fragment,{children:[o.jsx("p",{className:"text-xl text-stone-200 mb-8 font-bold",children:ne("introSlide4Line1",N)}),o.jsx("p",{className:"text-base text-stone-400 leading-loose",children:ne("introSlide4Line2",N)}),o.jsx("p",{className:"mt-4 text-base text-stone-400 leading-loose",children:ne("introSlide4Line3",N)}),o.jsx("p",{className:"mt-4 text-base text-stone-400 leading-loose",children:ne("introSlide4Line4",N)})]})},{content:o.jsxs(o.Fragment,{children:[o.jsx("p",{className:"text-lg text-stone-300 leading-loose mb-8",children:ne("introSlide5Line1",N)}),o.jsx("div",{className:"w-16 h-[1px] bg-stone-700 mx-auto my-8"}),o.jsx("p",{className:"text-xl text-stone-200 font-bold leading-relaxed",children:ne("introSlide5Line2",N)})]})}],I=()=>{C.current||(C.current=!0,z(0),setTimeout(()=>{A<q.length-1?(E(V=>V+1),z(1),setTimeout(()=>{C.current=!1},500)):m()},500))},x=q[A];return o.jsxs("div",{className:"flex-1 flex flex-col items-center justify-center bg-black p-4 md:p-12 relative overflow-hidden h-full cursor-pointer selection:bg-none font-serif-film",onClick:I,children:[o.jsx("div",{className:"absolute inset-4 md:inset-8 border-[6px] border-double border-stone-800 pointer-events-none opacity-60"}),o.jsx("div",{className:"absolute left-6 md:left-12 top-0 bottom-0 w-4 flex flex-col justify-around py-8 opacity-20 pointer-events-none",children:Array.from({length:12}).map((V,R)=>o.jsx("div",{className:"w-full h-5 bg-black rounded-[1px] border border-white/10 shadow-inner"},`l-${R}`))}),o.jsx("div",{className:"absolute right-6 md:right-12 top-0 bottom-0 w-4 flex flex-col justify-around py-8 opacity-20 pointer-events-none",children:Array.from({length:12}).map((V,R)=>o.jsx("div",{className:"w-full h-5 bg-black rounded-[1px] border border-white/10 shadow-inner"},`r-${R}`))}),o.jsxs("div",{className:"absolute top-12 text-[10px] text-stone-800 tracking-[0.3em]",children:["SCENE ",A+1," / ",q.length]}),o.jsx("div",{className:"w-full max-w-2xl text-center z-10 transition-opacity duration-500 ease-in-out",style:{opacity:f},children:o.jsx("div",{className:"text-stone-300 text-xl md:text-2xl leading-loose tracking-wide drop-shadow-md min-h-[300px] flex flex-col justify-center items-center",children:x==null?void 0:x.content})}),o.jsx("div",{className:"absolute bottom-12 flex flex-col items-center gap-4 animate-pulse",children:o.jsx("button",{className:"text-stone-600 text-xs tracking-[0.3em] uppercase hover:text-stone-400 transition-colors",children:A===q.length-1?ne("introClickStart",N):ne("introClickContinue",N)})}),o.jsx("div",{className:"absolute bottom-6 right-8 opacity-40 hover:opacity-100 transition-opacity",children:o.jsx("button",{onClick:V=>{V.stopPropagation(),m()},className:"text-stone-700 hover:text-stone-500 text-[10px] tracking-widest uppercase border border-stone-800/50 px-2 py-1 rounded-sm",children:ne("introSkip",N)})})]})},e0=({onComplete:m})=>{const A=[B("/assets/intro_film_1.jpg"),B("/assets/intro_film_2.jpg")];return M.useEffect(()=>{const E=setTimeout(()=>{m()},3e3);return()=>{clearTimeout(E)}},[m]),o.jsxs("div",{className:"absolute inset-0 bg-[#050505] z-40 flex items-center justify-center font-mono",children:[o.jsx("div",{className:"absolute inset-4 md:inset-8 border-[6px] border-double border-stone-800 pointer-events-none opacity-60 z-50"}),o.jsxs("div",{className:"relative w-[340px] h-auto overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.8)] scale-110 md:scale-100 transform rotate-1",children:[o.jsxs("div",{className:"bg-[#1a1a1a] border-x-[24px] border-[#0a0a0a] relative flex flex-col gap-[24px] py-8 box-border shadow-inner",children:[o.jsx("div",{className:"absolute left-[-18px] top-0 bottom-0 w-[14px] flex flex-col justify-start gap-[28px] py-1",children:Array.from({length:20}).map((E,f)=>o.jsx("div",{className:"w-full h-[18px] bg-black rounded-[1px] shadow-[inset_0_1px_2px_rgba(255,255,255,0.05),0_1px_0_rgba(255,255,255,0.02)] border border-white/5"},`l-${f}`))}),o.jsx("div",{className:"absolute right-[-18px] top-0 bottom-0 w-[14px] flex flex-col justify-start gap-[28px] py-1",children:Array.from({length:20}).map((E,f)=>o.jsx("div",{className:"w-full h-[18px] bg-black rounded-[1px] shadow-[inset_0_1px_2px_rgba(255,255,255,0.05),0_1px_0_rgba(255,255,255,0.02)] border border-white/5"},`r-${f}`))}),o.jsx("div",{className:"absolute left-[-30px] top-[40px] text-[8px] text-[#fbbf24] rotate-90 opacity-60 font-bold tracking-widest",children:"EASTMAN"}),o.jsx("div",{className:"absolute right-[-32px] top-[140px] text-[10px] text-[#fbbf24] -rotate-90 opacity-80 font-bold",children:"14"}),o.jsx("div",{className:"absolute left-[-30px] top-[260px] text-[8px] text-[#fbbf24] rotate-90 opacity-60 font-bold tracking-widest",children:"KODAK"}),o.jsx("div",{className:"absolute right-[-36px] top-[360px] text-[10px] text-[#fbbf24] -rotate-90 opacity-80 font-bold",children:"14A"}),A.map((E,f)=>o.jsxs("div",{className:"relative w-full aspect-[4/3] overflow-hidden bg-black mx-auto shadow-[inset_0_0_20px_rgba(0,0,0,1)] ring-1 ring-white/10",children:[o.jsx("img",{src:E,alt:`Film frame ${f}`,className:"w-full h-full object-cover sepia-[0.3] contrast-[1.15] brightness-[0.85] saturate-[0.8]"}),o.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle,transparent_40%,rgba(0,0,0,0.8)_100%)]"})]},f))]}),o.jsxs("div",{className:"pointer-events-none absolute inset-0 z-10 w-full h-full mix-blend-overlay opacity-60",children:[o.jsx("div",{className:"absolute inset-0 opacity-50 animate-grain-fine"}),o.jsx("div",{className:"absolute inset-0 opacity-20 animate-scratch-subtle"}),o.jsx("div",{className:"absolute inset-0 opacity-10 animate-grain-coarse"}),o.jsx("div",{className:"absolute inset-0 bg-[#4a3b2a] mix-blend-color opacity-20"}),o.jsx("div",{className:"absolute inset-0 bg-[#001a1a] mix-blend-soft-light opacity-30"})]})]})]})},t0=({currentTrack:m,isMuted:A=!0,onToggleMute:E,isEndingMusicPlaying:f=!1,onStopEndingMusic:z})=>{const C=M.useRef(null),N=M.useRef(Promise.resolve()),q=M.useRef(null),I=.4;M.useEffect(()=>{if(!C.current){const V=new Audio;V.loop=!0,V.volume=I,C.current=V}return()=>{C.current&&(C.current.pause(),C.current.src="")}},[]),M.useEffect(()=>{const V=C.current;V&&(N.current=N.current.then(async()=>{try{if(!m){V.pause(),q.current=null;return}q.current!==m&&(V.src=m,q.current=m,V.load()),A?V.pause():(V.volume=I,await V.play())}catch(R){console.warn("BackgroundMusic operation failed:",R)}}))},[m,A]);const x=()=>{f&&z&&z(),E==null||E()};return o.jsxs("button",{onClick:x,className:`
        ...
        `,title:A?"Turn Music On":"Turn Music Off",children:[o.jsxs("div",{className:`flex items-end gap-[2px] h-4 ${A?"opacity-40":""}`,children:[o.jsx("div",{className:`w-[3px] bg-current rounded-t-sm transition-all duration-300 ${A?"h-1":"h-3 animate-[pulse_0.8s_ease-in-out_infinite]"}`}),o.jsx("div",{className:`w-[3px] bg-current rounded-t-sm transition-all duration-300 ${A?"h-1":"h-5 animate-[pulse_1.2s_ease-in-out_infinite]"}`}),o.jsx("div",{className:`w-[3px] bg-current rounded-t-sm transition-all duration-300 ${A?"h-1":"h-2 animate-[pulse_1.0s_ease-in-out_infinite]"}`}),o.jsx("div",{className:`w-[3px] bg-current rounded-t-sm transition-all duration-300 ${A?"h-1":"h-4 animate-[pulse_0.6s_ease-in-out_infinite]"}`})]}),A&&o.jsx("div",{className:"absolute w-8 h-[1px] bg-stone-400 rotate-45 shadow-sm"})]})},a0=()=>{const{language:m,setLanguage:A}=en();return o.jsxs("div",{className:"flex items-center gap-4 bg-stone-900/50 backdrop-blur-sm px-4 py-2 rounded-full border border-stone-800",children:[o.jsx("button",{onClick:()=>A(gt.Chinese),className:`text-xs font-mono tracking-wider transition-all duration-300 ${m===gt.Chinese?"text-stone-100 font-bold scale-110 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]":"text-stone-600 hover:text-stone-400"}`,children:"中文"}),o.jsx("div",{className:"w-[1px] h-3 bg-stone-700"}),o.jsx("button",{onClick:()=>A(gt.English),className:`text-xs font-mono tracking-wider transition-all duration-300 ${m===gt.English?"text-stone-100 font-bold scale-110 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]":"text-stone-600 hover:text-stone-400"}`,children:"ENGLISH"})]})},n0=({onStart:m})=>{const[A,E]=M.useState(!1),f=()=>{E(!0),setTimeout(m,1e3)};return o.jsxs("div",{onClick:f,className:`fixed inset-0 bg-black flex items-center justify-center cursor-pointer transition-opacity duration-1000 ${A?"opacity-0":"opacity-100"} z-50`,children:[o.jsxs("div",{className:"flex flex-col items-center gap-6",children:[o.jsx("div",{className:"text-stone-100 font-mono text-sm tracking-[0.5em] uppercase opacity-80 hover:opacity-100 transition-opacity duration-700 blur-[0.5px] animate-pulse",style:{textShadow:"2px 0 rgba(255,0,0,0.5), -2px 0 rgba(0,255,255,0.5), 0 0 4px rgba(255,255,255,0.2)"},children:"Ghost in the Reel"}),o.jsx("img",{src:B("/hunstler_logo.jpg"),alt:"Hunstler Klub Logo",className:"w-24 h-auto opacity-80 mix-blend-screen blur-[0.5px] animate-pulse",style:{filter:"drop-shadow(0 0 4px rgba(255,255,255,0.2))"}}),o.jsx("div",{className:"flex gap-6 mt-8",onClick:z=>z.stopPropagation(),children:o.jsx(a0,{})}),o.jsx("div",{className:"text-stone-500 font-mono text-xs tracking-widest mt-4 animate-pulse",children:"[ CLICK TO ENTER ]"})]}),o.jsx("div",{className:"absolute bottom-8 right-8 text-stone-500 font-mono text-[10px] tracking-widest opacity-60",children:"By Hunstler Klub"})]})},eo="the-missing-reel-save",l0="1.0.0";class to{static saveGame(A){try{const E={...A,timestamp:Date.now(),version:l0};localStorage.setItem(eo,JSON.stringify(E)),console.log("[SaveManager] Game saved successfully",E)}catch(E){console.error("[SaveManager] Failed to save game:",E)}}static loadGame(){try{const A=localStorage.getItem(eo);if(!A)return console.log("[SaveManager] No save data found"),null;const E=JSON.parse(A);return!E.version||!E.timestamp?(console.warn("[SaveManager] Invalid save data format"),null):(console.log("[SaveManager] Game loaded successfully",E),E)}catch(A){return console.error("[SaveManager] Failed to load game:",A),null}}static hasSaveData(){try{return localStorage.getItem(eo)!==null}catch(A){return console.error("[SaveManager] Failed to check save data:",A),!1}}static clearSave(){try{localStorage.removeItem(eo),console.log("[SaveManager] Save data cleared")}catch(A){console.error("[SaveManager] Failed to clear save data:",A)}}static getSaveTimestamp(){const A=this.loadGame();return A?A.timestamp:null}}const i0=({onNewGame:m,onContinue:A})=>{const{language:E}=en(),[f,z]=M.useState(!1),[C,N]=M.useState(!1);M.useEffect(()=>{N(to.hasSaveData())},[]);const q=()=>{to.clearSave(),console.log("[SaveSelectScreen] Starting new game, save cleared"),z(!0),setTimeout(m,1e3)},I=()=>{console.log("[SaveSelectScreen] Continuing game"),z(!0),setTimeout(A,1e3)};return o.jsx("div",{className:`fixed inset-0 bg-black flex items-center justify-center transition-opacity duration-1000 ${f?"opacity-0":"opacity-100"} z-50`,children:o.jsxs("div",{className:"flex flex-col items-center gap-6",children:[o.jsx("div",{className:"text-[#8c8273] font-mono text-xs tracking-[0.3em] uppercase opacity-60 mb-4",children:"Select Option"}),o.jsxs("div",{className:"flex flex-col gap-4",children:[o.jsx("button",{onClick:q,className:`px-12 py-4 bg-[#1a1816] border border-[#3d342b] text-[#d6cbb8] font-mono text-sm tracking-widest uppercase
                                 hover:bg-[#2a2624] hover:border-[#a89078] hover:text-[#ffecd1] 
                                 transition-all duration-300 cursor-pointer min-w-[200px]`,children:ne("newGame",E)}),C&&o.jsx("button",{onClick:I,className:`px-12 py-4 bg-transparent border border-[#3d342b] text-[#8c8273] font-mono text-sm tracking-widest uppercase
                                     hover:bg-[#1a1816] hover:border-[#786650] hover:text-[#d6cbb8]
                                     transition-all duration-300 cursor-pointer min-w-[200px]`,children:ne("continueGame",E)})]}),!C&&o.jsx("div",{className:"text-[#4a4036] font-mono text-[10px] tracking-wider opacity-40 mt-4",children:"No save data found"})]})})},o0=({onComplete:m})=>{const[A,E]=M.useState(1),f=M.useRef(!1),{language:z}=en(),C=[{content:o.jsxs(o.Fragment,{children:[o.jsx("p",{className:"text-xl text-stone-200 leading-loose",children:ne("endingLine1",z)}),o.jsx("p",{className:"mt-8 text-stone-300",children:ne("endingLine2",z)}),o.jsx("div",{className:"w-16 h-[1px] bg-stone-700 mx-auto my-12"}),o.jsx("p",{className:"text-lg text-stone-400 leading-relaxed italic",children:ne("endingLine3",z)})]})}],N=()=>{f.current||(f.current=!0,E(0),setTimeout(()=>{m()},800))},q=C[0];return o.jsxs("div",{className:"flex-1 flex flex-col items-center justify-center bg-black p-4 md:p-12 relative overflow-hidden h-full cursor-pointer selection:bg-none font-serif-film",onClick:N,children:[o.jsx("div",{className:"absolute inset-4 md:inset-8 border-[6px] border-double border-stone-800 pointer-events-none opacity-60"}),o.jsx("div",{className:"absolute left-6 md:left-12 top-0 bottom-0 w-4 flex flex-col justify-around py-8 opacity-20 pointer-events-none",children:Array.from({length:12}).map((I,x)=>o.jsx("div",{className:"w-full h-5 bg-black rounded-[1px] border border-white/10 shadow-inner"},`l-${x}`))}),o.jsx("div",{className:"absolute right-6 md:right-12 top-0 bottom-0 w-4 flex flex-col justify-around py-8 opacity-20 pointer-events-none",children:Array.from({length:12}).map((I,x)=>o.jsx("div",{className:"w-full h-5 bg-black rounded-[1px] border border-white/10 shadow-inner"},`r-${x}`))}),o.jsx("div",{className:"absolute top-12 text-[10px] text-stone-800 tracking-[0.3em] uppercase",children:"EPILOGUE"}),o.jsx("div",{className:"w-full max-w-2xl text-center z-10 transition-opacity duration-800 ease-in-out",style:{opacity:A},children:o.jsx("div",{className:"text-stone-300 text-xl md:text-2xl leading-loose tracking-wide drop-shadow-md min-h-[300px] flex flex-col justify-center items-center",children:q==null?void 0:q.content})}),o.jsx("div",{className:"absolute bottom-12 flex flex-col items-center gap-4 animate-pulse",children:o.jsx("button",{className:"text-stone-600 text-xs tracking-[0.3em] uppercase hover:text-stone-400 transition-colors",children:ne("endingClickReturn",z)})})]})};var $=(m=>(m.INTRO="INTRO",m.INVENTORY="INVENTORY",m.RECORDER="RECORDER",m.NOTEBOOK="NOTEBOOK",m.FILM_SELECT="FILM_SELECT",m.FILM_VIEW="FILM_VIEW",m.ENDING="ENDING",m.FILM_LOOP="FILM_LOOP",m.TITLE_SCREEN="TITLE_SCREEN",m.SAVE_SELECT="SAVE_SELECT",m))($||{});const s0=()=>{const[m,A]=M.useState(()=>typeof window<"u"&&sessionStorage.getItem("the-missing-reel-skip-intro")?(sessionStorage.removeItem("the-missing-reel-skip-intro"),$.SAVE_SELECT):$.FILM_LOOP),[E,f]=M.useState(["log_auto"]),[z,C]=M.useState(["intro"]),[N,q]=M.useState([]),[I,x]=M.useState(!1),[V,R]=M.useState(null),[W,Le]=M.useState(!1),[ke,ze]=M.useState(!1),[Je,Me]=M.useState(!1),[ie,P]=M.useState(!1),pe=M.useRef(null),xe=M.useRef(null),we=M.useRef(null),K=M.useRef(null),le=M.useRef(null),[_e,st]=M.useState(!1),[je,Be]=M.useState(!1),Oe=M.useRef(null),ce=()=>{const u=to.loadGame();u&&(f(u.unlockedLogs),C(u.unlockedBlogs),q(u.unlockedReels),x(u.hasAutoPlayedRecorder),Be(u.hasEndingMusicFinished),console.log("[App] Game loaded from save"))};M.useEffect(()=>{ce()},[]),M.useEffect(()=>{const u=setTimeout(()=>{to.saveGame({unlockedLogs:E,unlockedBlogs:z,unlockedReels:N,hasAutoPlayedRecorder:I,hasEndingMusicFinished:je})},300);return()=>clearTimeout(u)},[E,z,N,I,je]),M.useEffect(()=>{if(!pe.current){const u=new Audio(B("/assets/recorder_music.mp3"));u.loop=!0,u.volume=.7,pe.current=u}return()=>{pe.current&&(pe.current.pause(),pe.current=null)}},[]),M.useEffect(()=>{if(!we.current){const u=new Audio(B("/assets/film_music.mp3"));u.loop=!0,u.volume=.7,we.current=u}return()=>{we.current&&(we.current.pause(),we.current=null)}},[]),M.useEffect(()=>{if(!le.current){const u=new Audio(B("/assets/end_music.mp3"));u.loop=!1,u.volume=.7,u.addEventListener("ended",()=>{Be(!0),st(!1)}),le.current=u}return()=>{le.current&&(le.current.pause(),le.current=null)}},[]),M.useEffect(()=>{const u=pe.current;if(!u)return;const j=ie&&!W,O=_e&&!je;if(j){if(O){const L=le.current;if(L&&L.volume>0){Oe.current&&clearInterval(Oe.current);const U=L.volume;let J=0;Oe.current=setInterval(()=>{J++,L.volume=Math.max(0,U-U/20*J),J>=20&&(L.pause(),Oe.current&&(clearInterval(Oe.current),Oe.current=null))},50)}}u.volume=.7,u.play().catch(L=>console.warn("Recorder music play failed:",L))}else{xe.current&&clearInterval(xe.current);const L=u.volume,U=20,J=L/U;let de=0;xe.current=setInterval(()=>{de++;const T=Math.max(0,L-J*de);if(u.volume=T,(de>=U||T<=0)&&(u.pause(),xe.current&&(clearInterval(xe.current),xe.current=null),_e&&!je)){const X=le.current;if(X&&X.paused){X.volume=0,X.play().catch(Ie=>console.warn("Ending music resume failed:",Ie));let ee=0;const se=setInterval(()=>{ee++,X.volume=Math.min(.7,.7/20*ee),ee>=20&&clearInterval(se)},50)}}},50)}return()=>{xe.current&&clearInterval(xe.current)}},[ie,m,W,_e,je]),M.useEffect(()=>{const u=we.current;if(!u)return;const O=(m===$.FILM_SELECT||m===$.FILM_VIEW)&&!W,L=_e&&!je;if(O){if(L){const U=le.current;if(U&&U.volume>0){Oe.current&&clearInterval(Oe.current);const J=U.volume;let de=0;Oe.current=setInterval(()=>{de++,U.volume=Math.max(0,J-J/20*de),de>=20&&(U.pause(),Oe.current&&(clearInterval(Oe.current),Oe.current=null))},50)}}u.volume=.7,u.play().catch(U=>console.warn("Film music play failed:",U))}else{K.current&&clearInterval(K.current);const U=u.volume,J=20,de=U/J;let T=0;K.current=setInterval(()=>{T++;const X=Math.max(0,U-de*T);if(u.volume=X,(T>=J||X<=0)&&(u.pause(),K.current&&(clearInterval(K.current),K.current=null),_e&&!je)){const ee=le.current;if(ee&&ee.paused){ee.volume=0,ee.play().catch(tt=>console.warn("Ending music resume failed:",tt));let se=0;const Ie=setInterval(()=>{se++,ee.volume=Math.min(.7,.7/20*se),se>=20&&clearInterval(Ie)},50)}}},50)}return()=>{K.current&&clearInterval(K.current)}},[m,W,_e,je]),M.useEffect(()=>{m===$.ENDING&&!_e&&!je&&(console.log("Entering ENDING view, setting ending music to play"),st(!0))},[m,_e,je]),M.useEffect(()=>{const u=le.current;if(u){if(console.log("Ending music effect:",{isEndingMusicPlaying:_e,hasEndingMusicFinished:je,isMusicMuted:W,recorderMusicActive:ie,view:m}),W)u.paused||(console.log("Pausing ending music (muted)"),u.pause());else if(_e&&!je){const j=ie&&m===$.RECORDER,O=m===$.FILM_SELECT||m===$.FILM_VIEW;console.log("Ending music should play?",{isRecorderActive:j,isFilmActive:O}),!j&&!O?u.paused&&(console.log("Starting ending music playback"),u.volume=.7,u.play().catch(L=>console.warn("Ending music play failed:",L))):u.paused||(console.log("Pausing ending music (priority module active)"),u.pause())}}},[_e,je,W,ie,m]);let De=null;m===$.RECORDER?De=Lh.recorder:m===$.NOTEBOOK?De=null:m===$.FILM_SELECT||m===$.FILM_VIEW?De=Lh.film:(m===$.INVENTORY||m===$.INTRO||m===$.FILM_LOOP||m===$.ENDING)&&(De=null);const _=u=>{switch(u){case"recorder":A($.RECORDER);break;case"notebook":A($.NOTEBOOK);break;case"film":A($.FILM_SELECT);break}},D=u=>{E.includes(u)||f(j=>[...j,u])},G=u=>{z.includes(u)||C(j=>[...j,u])},oe=u=>{N.includes(u)||q(j=>[...j,u])},ye=()=>{st(!1),Be(!0);const u=le.current;u&&(u.pause(),u.currentTime=0)},d=()=>{console.log("[App] Resetting game state for new game"),localStorage.removeItem("the-missing-reel-tutorial-seen"),f(["log_auto"]),C(["intro"]),q([]),x(!1),Be(!1),R(null),A($.INTRO)};return o.jsx(Xp,{children:o.jsxs(Ep,{disableFilmEffects:m===$.NOTEBOOK&&(Je||ke),children:[o.jsx(t0,{currentTrack:De,isMuted:W,onToggleMute:()=>Le(!W),isEndingMusicPlaying:_e,onStopEndingMusic:ye}),m===$.FILM_LOOP&&o.jsx(e0,{onComplete:()=>A($.TITLE_SCREEN)}),m===$.TITLE_SCREEN&&o.jsx(n0,{onStart:()=>A($.SAVE_SELECT)}),m===$.SAVE_SELECT&&o.jsx(i0,{onNewGame:d,onContinue:()=>A($.INVENTORY)}),m===$.INTRO&&o.jsx(Pp,{onComplete:()=>A($.INVENTORY)}),m===$.INVENTORY&&o.jsx(Mp,{items:Qp,onSelectItem:_,unlockedLogs:E,unlockedBlogs:z,unlockedReels:N}),m===$.RECORDER&&o.jsx(Zp,{onBack:()=>{P(!1),A($.INVENTORY)},unlockedLogs:E,onUnlockLog:D,hasAutoPlayed:I,setHasAutoPlayed:x,onTriggerEnding:()=>{P(!1),A($.ENDING)},onMusicStart:()=>P(!0)}),m===$.NOTEBOOK&&o.jsx(Kp,{onBack:()=>A($.INVENTORY),unlockedBlogs:z,onUnlockBlog:G,onViewChange:ze,isFlickerDisabled:Je,onToggleFlicker:()=>Me(u=>!u)}),m===$.FILM_SELECT&&o.jsx($p,{onBack:()=>A($.INVENTORY),onSelectReel:u=>{R(u),A($.FILM_VIEW)},unlockedReels:N,onUnlockReel:oe}),m===$.FILM_VIEW&&V&&(V.id==="reel_00"?o.jsx(Wp,{film:V,onBack:()=>A($.FILM_SELECT)}):o.jsx(Jp,{film:V,onBack:()=>A($.FILM_SELECT)})),m===$.ENDING&&o.jsx(o0,{onComplete:()=>A($.INVENTORY)})]})})},Zh=document.getElementById("root");if(!Zh)throw new Error("Could not find root element to mount to");const r0=Tp.createRoot(Zh);r0.render(o.jsx(_p.StrictMode,{children:o.jsx(s0,{})}));
