 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Th;function vp(){if(Th)return F;Th=1;var m=Symbol.for("react.transitional.element"),A=Symbol.for("react.portal"),E=Symbol.for("react.fragment"),f=Symbol.for("react.strict_mode"),z=Symbol.for("react.profiler"),C=Symbol.for("react.consumer"),j=Symbol.for("react.context"),q=Symbol.for("react.forward_ref"),I=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),U=Symbol.for("react.lazy"),R=Symbol.for("react.activity"),W=Symbol.iterator;function Le(d){return d===null||typeof d!="object"?null:(d=W&&d[W]||d["@@iterator"],typeof d=="function"?d:null)}var Se={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ze=Object.assign,Je={};function Me(d,u,N){this.props=d,this.context=u,this.refs=Je,this.updater=N||Se}Me.prototype.isReactComponent={},Me.prototype.setState=function(d,u){if(typeof d!="object"&&typeof d!="function"&&d!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,d,u,"setState")},Me.prototype.forceUpdate=function(d){this.updater.enqueueForceUpdate(this,d,"forceUpdate")};function ie(){}ie.prototype=Me.prototype;function ee(d,u,N){this.props=d,this.context=u,this.refs=Je,this.updater=N||Se}var pe=ee.prototype=new ie;pe.constructor=ee,ze(pe,Me.prototype),pe.isPureReactComponent=!0;var xe=Array.isArray;function we(){}var K={H:null,A:null,T:null,S:null},le=Object.prototype.hasOwnProperty;function _e(d,u,N){var O=N.ref;return{$$typeof:m,type:d,key:u,ref:O!==void 0?O:null,props:N}}function st(d,u){return _e(d.type,u,d.props)}function Ne(d){return typeof d=="object"&&d!==null&&d.$$typeof===m}function Be(d){var u={"=":"=0",":":"=2"};return"$"+d.replace(/[=:]/g,function(N){return u[N]})}var Oe=/\/+/g;function de(d,u){return typeof d=="object"&&d!==null&&d.key!=null?Be(""+d.key):u.toString(36)}function De(d){switch(d.status){case"fulfilled":return d.value;case"rejected":throw d.reason;default:switch(typeof d.status=="string"?d.then(we,we):(d.status="pending",d.then(function(u){d.status==="pending"&&(d.status="fulfilled",d.value=u)},function(u){d.status==="pending"&&(d.status="rejected",d.reason=u)})),d.status){case"fulfilled":return d.value;case"rejected":throw d.reason}}throw d}function _(d,u,N,O,L){var V=typeof d;(V==="undefined"||V==="boolean")&&(d=null);var J=!1;if(d===null)J=!0;else switch(V){case"bigint":case"string":case"number":J=!0;break;case"object":switch(d.$$typeof){case m:case A:J=!0;break;case U:return J=d._init,_(J(d._payload),u,N,O,L)}}if(J)return L=L(d),J=O===""?"."+de(d,0):O,xe(L)?(N="",J!=null&&(N=J.replace(Oe,"$&/")+"/"),_(L,u,N,"",function(X){return X})):L!=null&&(Ne(L)&&(L=st(L,N+(L.key==null||d&&d.key===L.key?"":(""+L.key).replace(Oe,"$&/")+"/")+J)),u.push(L)),1;J=0;var se=O===""?".":O+":";if(xe(d))for(var T=0;T<d.length;T++)O=d[T],V=se+de(O,T),J+=_(O,u,N,V,L);else if(T=Le(d),typeof T=="function")for(d=T.call(d),T=0;!(O=d.next()).done;)O=O.value,V=se+de(O,T++),J+=_(O,u,N,V,L);else if(V==="object"){if(typeof d.then=="function")return _(De(d),u,N,O,L);throw u=String(d),Error("Objects are not valid as a React child (found: "+(u==="[object Object]"?"object with keys {"+Object.keys(d).join(", ")+"}":u)+"). If you meant to render a collection of children, use an array instead.")}return J}function D(d,u,N){if(d==null)return d;var O=[],L=0;return _(d,O,"","",function(V){return u.call(N,V,L++)}),O}function G(d){if(d._status===-1){var u=d._result;u=u(),u.then(function(N){(d._status===0||d._status===-1)&&(d._status=1,d._result=N)},function(N){(d._status===0||d._status===-1)&&(d._status=2,d._result=N)}),d._status===-1&&(d._status=0,d._result=u)}if(d._status===1)return d._result.default;throw d._result}var oe=typeof reportError=="function"?reportError:function(d){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var u=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof d=="object"&&d!==null&&typeof d.message=="string"?String(d.message):String(d),error:d});if(!window.dispatchEvent(u))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",d);return}console.error(d)},ye={map:D,forEach:function(d,u,N){D(d,function(){u.apply(this,arguments)},N)},count:function(d){var u=0;return D(d,function(){u++}),u},toArray:function(d){return D(d,function(u){return u})||[]},only:function(d){if(!Ne(d))throw Error("React.Children.only expected to receive a single React element child.");return d}};return F.Activity=R,F.Children=ye,F.Component=Me,F.Fragment=E,F.Profiler=z,F.PureComponent=ee,F.StrictMode=f,F.Suspense=I,F.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=K,F.__COMPILER_RUNTIME={__proto__:null,c:function(d){return K.H.useMemoCache(d)}},F.cache=function(d){return function(){return d.apply(null,arguments)}},F.cacheSignal=function(){return null},F.cloneElement=function(d,u,N){if(d==null)throw Error("The argument must be a React element, but you passed "+d+".");var O=ze({},d.props),L=d.key;if(u!=null)for(V in u.key!==void 0&&(L=""+u.key),u)!le.call(u,V)||V==="key"||V==="__self"||V==="__source"||V==="ref"&&u.ref===void 0||(O[V]=u[V]);var V=arguments.length-2;if(V===1)O.children=N;else if(1<V){for(var J=Array(V),se=0;se<V;se++)J[se]=arguments[se+2];O.children=J}return _e(d.type,L,O)},F.createContext=function(d){return d={$$typeof:j,_currentValue:d,_currentValue2:d,_threadCount:0,Provider:null,Consumer:null},d.Provider=d,d.Consumer={$$typeof:C,_context:d},d},F.createElement=function(d,u,N){var O,L={},V=null;if(u!=null)for(O in u.key!==void 0&&(V=""+u.key),u)le.call(u,O)&&O!=="key"&&O!=="__self"&&O!=="__source"&&(L[O]=u[O]);var J=arguments.length-2;if(J===1)L.children=N;else if(1<J){for(var se=Array(J),T=0;T<J;T++)se[T]=arguments[T+2];L.children=se}if(d&&d.defaultProps)for(O in J=d.defaultProps,J)L[O]===void 0&&(L[O]=J[O]);return _e(d,V,L)},F.createRef=function(){return{current:null}},F.forwardRef=function(d){return{$$typeof:q,render:d}},F.isValidElement=Ne,F.lazy=function(d){return{$$typeof:U,_payload:{_status:-1,_result:d},_init:G}},F.memo=function(d,u){return{$$typeof:x,type:d,compare:u===void 0?null:u}},F.startTransition=function(d){var u=K.T,N={};K.T=N;try{var O=d(),L=K.S;L!==null&&L(N,O),typeof O=="object"&&O!==null&&typeof O.then=="function"&&O.then(we,oe)}catch(V){oe(V)}finally{u!==null&&N.types!==null&&(u.types=N.types),K.T=u}},F.unstable_useCacheRefresh=function(){return K.H.useCacheRefresh()},F.use=function(d){return K.H.use(d)},F.useActionState=function(d,u,N){return K.H.useActionState(d,u,N)},F.useCallback=function(d,u){return K.H.useCallback(d,u)},F.useContext=function(d){return K.H.useContext(d)},F.useDebugValue=function(){},F.useDeferredValue=function(d,u){return K.H.useDeferredValue(d,u)},F.useEffect=function(d,u){return K.H.useEffect(d,u)},F.useEffectEvent=function(d){return K.H.useEffectEvent(d)},F.useId=function(){return K.H.useId()},F.useImperativeHandle=function(d,u,N){return K.H.useImperativeHandle(d,u,N)},F.useInsertionEffect=function(d,u){return K.H.useInsertionEffect(d,u)},F.useLayoutEffect=function(d,u){return K.H.useLayoutEffect(d,u)},F.useMemo=function(d,u){return K.H.useMemo(d,u)},F.useOptimistic=function(d,u){return K.H.useOptimistic(d,u)},F.useReducer=function(d,u,N){return K.H.useReducer(d,u,N)},F.useRef=function(d){return K.H.useRef(d)},F.useState=function(d){return K.H.useState(d)},F.useSyncExternalStore=function(d,u,N){return K.H.useSyncExternalStore(d,u,N)},F.useTransition=function(){return K.H.useTransition()},F.version="19.2.3",F}var Eh;function Nr(){return Eh||(Eh=1,vr.exports=vp()),vr.exports}var M=Nr();const _p=Yh(M);var _r={exports:{}},Dl={},xr={exports:{}},wr={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zh;function xp(){return zh||(zh=1,(function(m){function A(_,D){var G=_.length;_.push(D);e:for(;0<G;){var oe=G-1>>>1,ye=_[oe];if(0<z(ye,D))_[oe]=D,_[G]=ye,G=oe;else break e}}function E(_){return _.length===0?null:_[0]}function f(_){if(_.length===0)return null;var D=_[0],G=_.pop();if(G!==D){_[0]=G;e:for(var oe=0,ye=_.length,d=ye>>>1;oe<d;){var u=2*(oe+1)-1,N=_[u],O=u+1,L=_[O];if(0>z(N,G))O<ye&&0>z(L,N)?(_[oe]=L,_[O]=G,oe=O):(_[oe]=N,_[u]=G,oe=u);else if(O<ye&&0>z(L,G))_[oe]=L,_[O]=G,oe=O;else break e}}return D}function z(_,D){var G=_.sortIndex-D.sortIndex;return G!==0?G:_.id-D.id}if(m.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var C=performance;m.unstable_now=function(){return C.now()}}else{var j=Date,q=j.now();m.unstable_now=function(){return j.now()-q}}var I=[],x=[],U=1,R=null,W=3,Le=!1,Se=!1,ze=!1,Je=!1,Me=typeof setTimeout=="function"?setTimeout:null,ie=typeof clearTimeout=="function"?clearTimeout:null,ee=typeof setImmediate<"u"?setImmediate:null;function pe(_){for(var D=E(x);D!==null;){if(D.callback===null)f(x);else if(D.startTime<=_)f(x),D.sortIndex=D.expirationTime,A(I,D);else break;D=E(x)}}function xe(_){if(ze=!1,pe(_),!Se)if(E(I)!==null)Se=!0,we||(we=!0,Be());else{var D=E(x);D!==null&&De(xe,D.startTime-_)}}var we=!1,K=-1,le=5,_e=-1;function st(){return Je?!0:!(m.unstable_now()-_e<le)}function Ne(){if(Je=!1,we){var _=m.unstable_now();_e=_;var D=!0;try{e:{Se=!1,ze&&(ze=!1,ie(K),K=-1),Le=!0;var G=W;try{t:{for(pe(_),R=E(I);R!==null&&!(R.expirationTime>_&&st());){var oe=R.callback;if(typeof oe=="function"){R.callback=null,W=R.priorityLevel;var ye=oe(R.expirationTime<=_);if(_=m.unstable_now(),typeof ye=="function"){R.callback=ye,pe(_),D=!0;break t}R===E(I)&&f(I),pe(_)}else f(I);R=E(I)}if(R!==null)D=!0;else{var d=E(x);d!==null&&De(xe,d.startTime-_),D=!1}}break e}finally{R=null,W=G,Le=!1}D=void 0}}finally{D?Be():we=!1}}}var Be;if(typeof ee=="function")Be=function(){ee(Ne)};else if(typeof MessageChannel<"u"){var Oe=new MessageChannel,de=Oe.port2;Oe.port1.onmessage=Ne,Be=function(){de.postMessage(null)}}else Be=function(){Me(Ne,0)};function De(_,D){K=Me(function(){_(m.unstable_now())},D)}m.unstable_IdlePriority=5,m.unstable_ImmediatePriority=1,m.unstable_LowPriority=4,m.unstable_NormalPriority=3,m.unstable_Profiling=null,m.unstable_UserBlockingPriority=2,m.unstable_cancelCallback=function(_){_.callback=null},m.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):le=0<_?Math.floor(1e3/_):5},m.unstable_getCurrentPriorityLevel=function(){return W},m.unstable_next=function(_){switch(W){case 1:case 2:case 3:var D=3;break;default:D=W}var G=W;W=D;try{return _()}finally{W=G}},m.unstable_requestPaint=function(){Je=!0},m.unstable_runWithPriority=function(_,D){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var G=W;W=_;try{return D()}finally{W=G}},m.unstable_scheduleCallback=function(_,D,G){var oe=m.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?oe+G:oe):G=oe,_){case 1:var ye=-1;break;case 2:ye=250;break;case 5:ye=1073741823;break;case 4:ye=1e4;break;default:ye=5e3}return ye=G+ye,_={id:U++,callback:D,priorityLevel:_,startTime:G,expirationTime:ye,sortIndex:-1},G>oe?(_.sortIndex=G,A(x,_),E(I)===null&&_===E(x)&&(ze?(ie(K),K=-1):ze=!0,De(xe,G-oe))):(_.sortIndex=ye,A(I,_),Se||Le||(Se=!0,we||(we=!0,Be()))),_},m.unstable_shouldYield=st,m.unstable_wrapCallback=function(_){var D=W;return function(){var G=W;W=D;try{return _.apply(this,arguments)}finally{W=G}}}})(wr)),wr}var Mh;function wp(){return Mh||(Mh=1,xr.exports=xp()),xr.exports}var kr={exports:{}},rt={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Oh;function kp(){if(Oh)return rt;Oh=1;var m=Nr();function A(I){var x="https://react.dev/errors/"+I;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var U=2;U<arguments.length;U++)x+="&args[]="+encodeURIComponent(arguments[U])}return"Minified React error #"+I+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function E(){}var f={d:{f:E,r:function(){throw Error(A(522))},D:E,C:E,L:E,m:E,X:E,S:E,M:E},p:0,findDOMNode:null},z=Symbol.for("react.portal");function C(I,x,U){var R=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:z,key:R==null?null:""+R,children:I,containerInfo:x,implementation:U}}var j=m.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function q(I,x){if(I==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return rt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=f,rt.createPortal=function(I,x){var U=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(A(299));return C(I,x,null,U)},rt.flushSync=function(I){var x=j.T,U=f.p;try{if(j.T=null,f.p=2,I)return I()}finally{j.T=x,f.p=U,f.d.f()}},rt.preconnect=function(I,x){typeof I=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,f.d.C(I,x))},rt.prefetchDNS=function(I){typeof I=="string"&&f.d.D(I)},rt.preinit=function(I,x){if(typeof I=="string"&&x&&typeof x.as=="string"){var U=x.as,R=q(U,x.crossOrigin),W=typeof x.integrity=="string"?x.integrity:void 0,Le=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;U==="style"?f.d.S(I,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:R,integrity:W,fetchPriority:Le}):U==="script"&&f.d.X(I,{crossOrigin:R,integrity:W,fetchPriority:Le,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},rt.preinitModule=function(I,x){if(typeof I=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var U=q(x.as,x.crossOrigin);f.d.M(I,{crossOrigin:U,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&f.d.M(I)},rt.preload=function(I,x){if(typeof I=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var U=x.as,R=q(U,x.crossOrigin);f.d.L(I,U,{crossOrigin:R,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},rt.preloadModule=function(I,x){if(typeof I=="string")if(x){var U=q(x.as,x.crossOrigin);f.d.m(I,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:U,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else f.d.m(I)},rt.requestFormReset=function(I){f.d.r(I)},rt.unstable_batchedUpdates=function(I,x){return I(x)},rt.useFormState=function(I,x,U){return j.H.useFormState(I,x,U)},rt.useFormStatus=function(){return j.H.useHostTransitionStatus()},rt.version="19.2.3",rt}var Dh;function Ap(){if(Dh)return kr.exports;Dh=1;function m(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(m)}catch(A){console.error(A)}}return m(),kr.exports=kp(),kr.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ih;function Sp(){if(Ih)return Dl;Ih=1;var m=wp(),A=Nr(),E=Ap();function f(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)t+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function z(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function C(e){var t=e,a=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(a=t.return),e=t.return;while(e)}return t.tag===3?a:null}function j(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function q(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function I(e){if(C(e)!==e)throw Error(f(188))}function x(e){var t=e.alternate;if(!t){if(t=C(e),t===null)throw Error(f(188));return t!==e?null:e}for(var a=e,n=t;;){var l=a.return;if(l===null)break;var i=l.alternate;if(i===null){if(n=l.return,n!==null){a=n;continue}break}if(l.child===i.child){for(i=l.child;i;){if(i===a)return I(l),e;if(i===n)return I(l),t;i=i.sibling}throw Error(f(188))}if(a.return!==n.return)a=l,n=i;else{for(var s=!1,r=l.child;r;){if(r===a){s=!0,a=l,n=i;break}if(r===n){s=!0,n=l,a=i;break}r=r.sibling}if(!s){for(r=i.child;r;){if(r===a){s=!0,a=i,n=l;break}if(r===n){s=!0,n=i,a=l;break}r=r.sibling}if(!s)throw Error(f(189))}}if(a.alternate!==n)throw Error(f(190))}if(a.tag!==3)throw Error(f(188));return a.stateNode.current===a?e:t}function U(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=U(e),t!==null)return t;e=e.sibling}return null}var R=Object.assign,W=Symbol.for("react.element"),Le=Symbol.for("react.transitional.element"),Se=Symbol.for("react.portal"),ze=Symbol.for("react.fragment"),Je=Symbol.for("react.strict_mode"),Me=Symbol.for("react.profiler"),ie=Symbol.for("react.consumer"),ee=Symbol.for("react.context"),pe=Symbol.for("react.forward_ref"),xe=Symbol.for("react.suspense"),we=Symbol.for("react.suspense_list"),K=Symbol.for("react.memo"),le=Symbol.for("react.lazy"),_e=Symbol.for("react.activity"),st=Symbol.for("react.memo_cache_sentinel"),Ne=Symbol.iterator;function Be(e){return e===null||typeof e!="object"?null:(e=Ne&&e[Ne]||e["@@iterator"],typeof e=="function"?e:null)}var Oe=Symbol.for("react.client.reference");function de(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Oe?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case ze:return"Fragment";case Me:return"Profiler";case Je:return"StrictMode";case xe:return"Suspense";case we:return"SuspenseList";case _e:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case Se:return"Portal";case ee:return e.displayName||"Context";case ie:return(e._context.displayName||"Context")+".Consumer";case pe:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case K:return t=e.displayName||null,t!==null?t:de(e.type)||"Memo";case le:t=e._payload,e=e._init;try{return de(e(t))}catch{}}return null}var De=Array.isArray,_=A.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,D=E.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G={pending:!1,data:null,method:null,action:null},oe=[],ye=-1;function d(e){return{current:e}}function u(e){0>ye||(e.current=oe[ye],oe[ye]=null,ye--)}function N(e,t){ye++,oe[ye]=e.current,e.current=t}var O=d(null),L=d(null),V=d(null),J=d(null);function se(e,t){switch(N(V,t),N(L,e),N(O,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?Jd(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=Jd(t),e=Wd(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}u(O),N(O,e)}function T(){u(O),u(L),u(V)}function X(e){e.memoizedState!==null&&N(J,e);var t=O.current,a=Wd(t,e.type);t!==a&&(N(L,e),N(O,a))}function te(e){L.current===e&&(u(O),u(L)),J.current===e&&(u(J),Tl._currentValue=G)}var re,Ie;function tt(e){if(re===void 0)try{throw Error()}catch(a){var t=a.stack.trim().match(/\n( *(at )?)/);re=t&&t[1]||"",Ie=-1<a.stack.indexOf(`
...
`).map(te=>te.trim()).filter(te=>te.length>0).map((te,re)=>{if(te.startsWith("（")||te.startsWith("("))return{id:re,speaker:null,text:te,type:"direction"};const Ie=te.match(/^([^：:]+)[：:](.+)$/);return Ie?{id:re,speaker:Ie[1].trim(),text:Ie[2].trim(),type:"dialogue"}:{id:re,speaker:null,text:te,type:"direction"}}),ye=()=>{const T=x.trim(),X=R.trim();if(!T||!X){Se("请输入完整的姓名和日期。");return}const te=`${T}_${X}`.toLowerCase(),re=Ar.find(Ie=>Ie.searchId.toLowerCase()===te);re?A.includes(re.id)?(Se("该录音已存在于列表中。"),d(re)):(E(re.id),Se("检索成功。加载中..."),setTimeout(()=>{d(re),U(""),W("")},1e3)):Se("错误：未找到对应编号的录音。")},d=T=>{G.current&&clearTimeout(G.current);const X=oe(T.content);if(Je(X),ie(0),I(T),X.length>0&&X[0].type==="direction"){const re=X[0].text.split(/([，。；！])/).reduce((We,Ut,Ca)=>(Ut.match(/[，。；！]/)&&Ca>0?We[We.length-1]+=Ut:Ut.trim()&&We.push(Ut),We),[]);Oe(re),De(0),D(!1);const Ie=re.join("").length;let tt=0;const $e=()=>{if(tt++,De(tt),tt<Ie){const We=Math.random()*30+30;G.current=setTimeout($e,We)}else setTimeout(()=>{D(!0),j==null||j()},500)};$e()}else Oe([]),D(!0),j==null||j()};M.useEffect(()=>()=>{G.current&&clearTimeout(G.current)},[]),M.useEffect(()=>{if(f)return;const T=Ar.find(X=>X.isAutoPlay);T&&A.includes(T.id)&&(z(!0),setTimeout(()=>{d(T)},500))},[f,A,z]);const u=M.useMemo(()=>{const T=Me*Sr;return ze.slice(T,T+Sr)},[ze,Me]),N=Math.ceil(ze.length/Sr),O=(T,X)=>ze.find((re,Ie)=>Ie<T&&re.speaker===X)?null:X,L=T=>T.split(/__([^_]+)__/g).map((te,re)=>re%2===1?o.jsx("span",{className:"text-red-400 border-b border-red-500/40 pb-0.5 mx-1 font-bold tracking-wider",children:te},re):o.jsx("span",{children:te},re)),V=T=>T.includes("陌生人1")||T.includes("Stranger 1")?"text-red-600 font-bold":T.includes("苹果")||T.includes("Apple")?"text-stone-400":"text-amber-700",J=T=>T.includes("陌生人1")||T.includes("Stranger 1")?"text-red-500/90 border-red-900/50 glitch-text":T.includes("苹果")||T.includes("Apple")?"text-stone-200 border-stone-600":"text-amber-500/90 border-amber-900/50",{language:se}=en();return o.jsxs("div",{className:"flex-1 flex flex-col bg-stone-900 relative",children:[o.jsxs("div",{className:"h-14 sm:h-16 border-b border-stone-800 flex items-center justify-between px-3 sm:px-6 bg-stone-900 shadow-md z-10",children:[o.jsx("button",{onClick:m,className:"text-stone-400 hover:text-white text-[10px] sm:text-xs font-mono tracking-widest uppercase shrink-0",children:"[ OFF ]"}),o.jsxs("div",{className:"flex items-center gap-2 sm:gap-4 flex-1 justify-end",children:[o.jsx("span",{className:"text-[10px] text-stone-400 uppercase tracking-widest hidden lg:inline",children:"Tape Index:"}),o.jsxs("div",{className:"flex bg-stone-800/80 border border-stone-700 rounded-sm overflow-hidden group focus-within:border-stone-500 transition-colors items-center",children:[o.jsx("input",{type:"text",value:x,onChange:T=>U(T.target.value),placeholder:P("placeholderName",se),className:"bg-transparent text-stone-100 px-1.5 sm:px-2 py-1 text-xs sm:text-sm focus:outline-none w-14 sm:w-20 text-center font-serif-film placeholder-stone-600"}),o.jsx("span",{className:"text-stone-400 font-mono select-none text-xs",children:"_"}),o.jsx("input",{type:"text",value:R,onChange:T=>W(T.target.value),placeholder:P("placeholderDate",se),className:"bg-transparent text-stone-100 px-1.5 sm:px-2 py-1 text-xs sm:text-sm focus:outline-none w-16 sm:w-24 text-center font-serif-film placeholder-stone-600"}),o.jsx("button",{onClick:ye,className:"text-stone-300 bg-stone-700 px-2 sm:px-3 py-1 text-[10px] sm:text-xs border-l border-stone-600 hover:bg-stone-600 hover:text-white transition-colors h-full",children:"PLAY"})]})]})]}),o.jsxs("div",{className:"flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden relative",children:[o.jsxs("div",{className:`
        ...
        `,children:[o.jsx("div",{className:"p-4 border-b border-stone-800 text-[10px] text-stone-400 font-mono text-center tracking-widest",children:"ARCHIVED RECORDINGS"}),o.jsxs("div",{className:"flex-1 overflow-y-auto p-2 space-y-2 scrollbar-hide",children:[Le!=="等待输入..."&&Le!=="WAITING FOR INPUT..."&&o.jsx("div",{className:"text-xs text-amber-500 p-2 font-mono text-center animate-pulse",children:Le}),Ne.map(T=>{const X=(q==null?void 0:q.id)===T.id;return o.jsxs("button",{onClick:()=>d(T),className:`
                            ...
                            `,children:[o.jsxs("div",{className:"flex items-baseline justify-between relative z-10",children:[o.jsx("span",{className:`font-mono text-xs ${X?"text-amber-500":"text-stone-600 group-hover:text-stone-500"}`,children:X?"● PLAYING":"○ READY"}),X&&o.jsxs("span",{className:"text-[10px] animate-pulse",children:["00:0",Math.floor(Math.random()*9),"..."]})]}),o.jsx("div",{className:"mt-2 font-serif-film text-sm tracking-wide truncate relative z-10",children:T.title})]},T.id)})]}),st>1&&o.jsxs("div",{className:"p-2 border-t border-stone-800 flex justify-between items-center bg-stone-900",children:[o.jsx("button",{onClick:()=>K(T=>Math.max(0,T-1)),disabled:we===0,className:"text-stone-500 hover:text-stone-300 disabled:opacity-30 disabled:hover:text-stone-500 px-2 py-1 text-xs font-mono",children:"< PREV"}),o.jsxs("span",{className:"text-[10px] text-stone-600 font-mono",children:["PG ",we+1,"/",st]}),o.jsx("button",{onClick:()=>K(T=>Math.min(st-1,T+1)),disabled:we===st-1,className:"text-stone-500 hover:text-stone-300 disabled:opacity-30 disabled:hover:text-stone-500 px-2 py-1 text-xs font-mono",children:"NEXT >"})]})]}),o.jsxs("div",{className:"flex-1 bg-black relative flex flex-col items-center justify-center p-6 overflow-y-auto",children:[o.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(30,30,30,1)_0%,rgba(0,0,0,1)_100%)]"}),q?o.jsxs(o.Fragment,{children:[_&&N>1&&o.jsxs(o.Fragment,{children:[o.jsx("button",{onClick:()=>ie(T=>Math.max(0,T-1)),disabled:Me===0,className:"absolute left-0 top-1/2 -translate-y-1/2 z-50 p-3 md:p-4 text-stone-600 hover:text-stone-300 disabled:opacity-0 transition-all opacity-50 hover:opacity-100",children:o.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:2,stroke:"currentColor",className:"w-6 h-6 md:w-8 md:h-8",children:o.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.75 19.5L8.25 12l7.5-7.5"})})}),o.jsx("button",{onClick:()=>{Me===N-1?(q==null?void 0:q.id)==="awen_20231103"&&(C==null||C()):ie(T=>T+1)},disabled:Me===N-1&&(q==null?void 0:q.id)!=="awen_20231103",className:"absolute right-0 top-1/2 -translate-y-1/2 z-50 p-3 md:p-4 text-stone-600 hover:text-stone-300 disabled:opacity-0 transition-all opacity-50 hover:opacity-100",children:o.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:2,stroke:"currentColor",className:"w-6 h-6 md:w-8 md:h-8",children:o.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M8.25 4.5l7.5 7.5-7.5 7.5"})})}),o.jsx("div",{className:"absolute bottom-6 left-0 right-0 flex justify-center gap-3 z-50",children:Array.from({length:N}).map((T,X)=>o.jsx("div",{className:`rounded-full transition-all duration-300 ${X===Me?"w-2 h-2 bg-[#DA291C] shadow-[0_0_8px_rgba(218,41,28,0.6)]":"w-1.5 h-1.5 bg-stone-800"}`},X))})]}),o.jsxs("div",{className:"w-full max-w-2xl relative z-10 flex flex-col h-full max-h-[70vh] sm:max-h-[600px] mb-8 sm:mb-12 px-4 sm:px-8 md:px-16",children:[o.jsx("div",{className:"text-center mb-8 opacity-70",children:o.jsxs("h2",{className:"text-stone-500 text-xs font-mono tracking-[0.5em] uppercase border-b border-stone-800 pb-2 inline-block",children:[q.title," // PAGE ",Me+1]})}),o.jsx("div",{className:"flex-1 flex flex-col justify-center space-y-8 min-h-[300px]",children:u.map(T=>{const X=T.id===0;return!_&&!X?null:o.jsx("div",{className:"w-full animate-in fade-in slide-in-from-bottom-2 duration-700 fill-mode-both",children:T.type==="direction"?o.jsx("div",{className:"text-center flex flex-col gap-2 items-center",children:X&&!_?o.jsx("div",{className:"space-y-2",children:(()=>{let re=0;return Be.map((Ie,tt)=>{const $e=re,We=$e+Ie.length;if(re+=Ie.length,de<=$e)return null;const Ut=Math.min(Ie.length,de-$e),Ca=Ie.slice(0,Ut);return o.jsxs("p",{className:"text-stone-600 italic font-serif-film text-sm md:text-base leading-relaxed tracking-wider px-8",children:[L(Ca),de>$e&&de<We&&o.jsx("span",{className:"inline-block w-2 h-4 bg-stone-500 ml-1 animate-pulse align-middle"})]},tt)})})()}):o.jsx("p",{className:`
                                                ...
                                                `,children:X?Be.map((re,Ie)=>o.jsx("span",{className:"block mb-2",children:L(re)},Ie)):L(T.text)})}):o.jsxs("div",{className:"flex flex-col gap-1",children:[T.speaker&&O(T.id,T.speaker)&&o.jsx("span",{className:`
      ...
      `}),j&&o.jsxs("div",{className:"fixed inset-0 z-50 bg-black/95 flex items-center justify-center p-4 cursor-zoom-out animate-in fade-in duration-200",onClick:()=>q(null),children:[o.jsx("button",{className:"absolute top-6 right-6 text-stone-400 hover:text-white text-xs font-mono tracking-widest uppercase z-10 transition-colors",onClick:()=>q(null),children:"[ CLOSE ]"}),o.jsxs("div",{className:"relative max-w-[90vw] max-h-[90vh] flex items-center justify-center",children:[o.jsx("img",{src:j,alt:"Zoomed frame",className:"max-w-full max-h-[90vh] object-contain shadow-2xl",onClick:I=>I.stopPropagation()}),o.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/noise-lines.png')] opacity-20 pointer-events-none mix-blend-overlay"})]}),o.jsx("div",{className:"absolute bottom-6 left-0 right-0 text-center",children:o.jsx("span",{className:"text-stone-500 text-xs font-mono tracking-wide",children:"[ CLICK ANYWHERE TO CLOSE ]"})})]})]})},Wp=({film:m,onBack:A})=>{const E=Array.isArray(m.contentImage)?m.contentImage:[m.contentImage],[f,z]=M.useState(null);return o.jsxs("div",{className:"flex-1 bg-[#050505] flex flex-col relative p-8 overflow-hidden",children:[o.jsx("div",{className:"absolute inset-0 opacity-40 bg-[url('https://www.transparenttextures.com/patterns/dark-leather.png')] z-0 pointer-events-none"}),o.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-black/0 to-black/60 z-0 pointer-events-none"}),o.jsxs("div",{className:"relative z-30 flex justify-between items-center mb-8 px-4",children:[o.jsx("button",{onClick:A,className:"text-stone-500 hover:text-white text-xs font-mono tracking-widest uppercase transition-colors",children:"[ CLOSE ARCHIVE ]"}),o.jsx("div",{className:"text-stone-600 font-mono text-[10px] tracking-[0.2em] uppercase",children:"Batch 00 • Shredded Fragments • Processed Oct 1984"})]}),o.jsx("div",{className:"flex-1 relative z-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 overflow-y-auto px-4 scrollbar-hide pb-32",children:E.map((C,j)=>o.jsxs("div",{onClick:()=>z(j),className:`group relative aspect-[4/3] bg-black shadow-2xl transition-all duration-500 hover:scale-105 hover:z-40 
        ...
        `,title:A?"Turn Music On":"Turn Music Off",children:[o.jsxs("div",{className:`flex items-end gap-[2px] h-4 ${A?"opacity-40":""}`,children:[o.jsx("div",{className:`w-[3px] bg-current rounded-t-sm transition-all duration-300 ${A?"h-1":"h-3 animate-[pulse_0.8s_ease-in-out_infinite]"}`}),o.jsx("div",{className:`w-[3px] bg-current rounded-t-sm transition-all duration-300 ${A?"h-1":"h-5 animate-[pulse_1.2s_ease-in-out_infinite]"}`}),o.jsx("div",{className:`w-[3px] bg-current rounded-t-sm transition-all duration-300 ${A?"h-1":"h-2 animate-[pulse_1.0s_ease-in-out_infinite]"}`}),o.jsx("div",{className:`w-[3px] bg-current rounded-t-sm transition-all duration-300 ${A?"h-1":"h-4 animate-[pulse_0.6s_ease-in-out_infinite]"}`})]}),A&&o.jsx("div",{className:"absolute w-8 h-[1px] bg-stone-400 rotate-45 shadow-sm"})]})},ay=()=>{const{language:m,setLanguage:A}=en();return o.jsxs("div",{className:"flex items-center gap-4 bg-stone-900/50 backdrop-blur-sm px-4 py-2 rounded-full border border-stone-800",children:[o.jsx("button",{onClick:()=>A(gt.Chinese),className:`text-xs font-mono tracking-wider transition-all duration-300 ${m===gt.Chinese?"text-stone-100 font-bold scale-110 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]":"text-stone-600 hover:text-stone-400"}`,children:"中文"}),o.jsx("div",{className:"w-[1px] h-3 bg-stone-700"}),o.jsx("button",{onClick:()=>A(gt.English),className:`text-xs font-mono tracking-wider transition-all duration-300 ${m===gt.English?"text-stone-100 font-bold scale-110 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]":"text-stone-600 hover:text-stone-400"}`,children:"ENGLISH"})]})},ny=({onStart:m})=>{const[A,E]=M.useState(!1),f=()=>{E(!0),setTimeout(m,1e3)};return o.jsxs("div",{onClick:f,className:`fixed inset-0 bg-black flex items-center justify-center cursor-pointer transition-opacity duration-1000 ${A?"opacity-0":"opacity-100"} z-50`,children:[o.jsxs("div",{className:"flex flex-col items-center gap-6",children:[o.jsx("div",{className:"text-stone-100 font-mono text-sm tracking-[0.5em] uppercase opacity-80 hover:opacity-100 transition-opacity duration-700 blur-[0.5px] animate-pulse",style:{textShadow:"2px 0 rgba(255,0,0,0.5), -2px 0 rgba(0,255,255,0.5), 0 0 4px rgba(255,255,255,0.2)"},children:"Ghost in the Reel"}),o.jsx("img",{src:B("/hunstler_logo.jpg"),alt:"Hunstler Klub Logo",className:"w-24 h-auto opacity-80 mix-blend-screen blur-[0.5px] animate-pulse",style:{filter:"drop-shadow(0 0 4px rgba(255,255,255,0.2))"}}),o.jsx("div",{className:"flex gap-6 mt-8",onClick:z=>z.stopPropagation(),children:o.jsx(ay,{})}),o.jsx("div",{className:"text-stone-500 font-mono text-xs tracking-widest mt-4 animate-pulse",children:"[ CLICK TO ENTER ]"})]}),o.jsx("div",{className:"absolute bottom-8 right-8 text-stone-500 font-mono text-[10px] tracking-widest opacity-60",children:"By Hunstler Klub"})]})},eo="the-missing-reel-save",ly="1.0.0";class to{static saveGame(A){try{const E={...A,timestamp:Date.now(),version:ly};localStorage.setItem(eo,JSON.stringify(E)),console.log("[SaveManager] Game saved successfully",E)}catch(E){console.error("[SaveManager] Failed to save game:",E)}}static loadGame(){try{const A=localStorage.getItem(eo);if(!A)return console.log("[SaveManager] No save data found"),null;const E=JSON.parse(A);return!E.version||!E.timestamp?(console.warn("[SaveManager] Invalid save data format"),null):(console.log("[SaveManager] Game loaded successfully",E),E)}catch(A){return console.error("[SaveManager] Failed to load game:",A),null}}static hasSaveData(){try{return localStorage.getItem(eo)!==null}catch(A){return console.error("[SaveManager] Failed to check save data:",A),!1}}static clearSave(){try{localStorage.removeItem(eo),console.log("[SaveManager] Save data cleared")}catch(A){console.error("[SaveManager] Failed to clear save data:",A)}}static getSaveTimestamp(){const A=this.loadGame();return A?A.timestamp:null}}const iy=({onNewGame:m,onContinue:A})=>{const{language:E}=en(),[f,z]=M.useState(!1),[C,j]=M.useState(!1);M.useEffect(()=>{j(to.hasSaveData())},[]);const q=()=>{to.clearSave(),console.log("[SaveSelectScreen] Starting new game, save cleared"),z(!0),setTimeout(m,1e3)},I=()=>{console.log("[SaveSelectScreen] Continuing game"),z(!0),setTimeout(A,1e3)};return o.jsx("div",{className:`fixed inset-0 bg-black flex items-center justify-center transition-opacity duration-1000 ${f?"opacity-0":"opacity-100"} z-50`,children:o.jsxs("div",{className:"flex flex-col items-center gap-6",children:[o.jsx("div",{className:"text-[#8c8273] font-mono text-xs tracking-[0.3em] uppercase opacity-60 mb-4",children:"Select Option"}),o.jsxs("div",{className:"flex flex-col gap-4",children:[o.jsx("button",{onClick:q,className:`px-12 py-4 bg-[#1a1816] border border-[#3d342b] text-[#d6cbb8] font-mono text-sm tracking-widest uppercase
                                 ...
                                 transition-all duration-300 cursor-pointer min-w-[200px]`,children:P("newGame",E)}),C&&o.jsx("button",{onClick:I,className:`px-12 py-4 bg-transparent border border-[#3d342b] text-[#8c8273] font-mono text-sm tracking-widest uppercase
                                     ...
                                     transition-all duration-300 cursor-pointer min-w-[200px]`,children:P("continueGame",E)})]}),!C&&o.jsx("div",{className:"text-[#4a4036] font-mono text-[10px] tracking-wider opacity-40 mt-4",children:"No save data found"})]})})},oy=({onComplete:m})=>{const[A,E]=M.useState(1),f=M.useRef(!1),{language:z}=en(),C=[{content:o.jsxs(o.Fragment,{children:[o.jsx("p",{className:"text-xl text-stone-200 leading-loose",children:P("endingLine1",z)}),o.jsx("p",{className:"mt-8 text-stone-300",children:P("endingLine2",z)}),o.jsx("div",{className:"w-16 h-[1px] bg-stone-700 mx-auto my-12"}),o.jsx("p",{className:"text-lg text-stone-400 leading-relaxed italic",children:P("endingLine3",z)})]})}],j=()=>{f.current||(f.current=!0,E(0),setTimeout(()=>{m()},800))},q=C[0];return o.jsxs("div",{className:"flex-1 flex flex-col items-center justify-center bg-black p-4 md:p-12 relative overflow-hidden h-full cursor-pointer selection:bg-none font-serif-film",onClick:j,children:[o.jsx("div",{className:"absolute inset-4 md:inset-8 border-[6px] border-double border-stone-800 pointer-events-none opacity-60"}),o.jsx("div",{className:"absolute left-6 md:left-12 top-0 bottom-0 w-4 flex flex-col justify-around py-8 opacity-20 pointer-events-none",children:Array.from({length:12}).map((I,x)=>o.jsx("div",{className:"w-full h-5 bg-black rounded-[1px] border border-white/10 shadow-inner"},`l-${x}`))}),o.jsx("div",{className:"absolute right-6 md:right-12 top-0 bottom-0 w-4 flex flex-col justify-around py-8 opacity-20 pointer-events-none",children:Array.from({length:12}).map((I,x)=>o.jsx("div",{className:"w-full h-5 bg-black rounded-[1px] border border-white/10 shadow-inner"},`r-${x}`))}),o.jsx("div",{className:"absolute top-12 text-[10px] text-stone-800 tracking-[0.3em] uppercase",children:"EPILOGUE"}),o.jsx("div",{className:"w-full max-w-2xl text-center z-10 transition-opacity duration-800 ease-in-out",style:{opacity:A},children:o.jsx("div",{className:"text-stone-300 text-xl md:text-2xl leading-loose tracking-wide drop-shadow-md min-h-[300px] flex flex-col justify-center items-center",children:q==null?void 0:q.content})}),o.jsx("div",{className:"absolute bottom-12 flex flex-col items-center gap-4 animate-pulse",children:o.jsx("button",{className:"text-stone-600 text-xs tracking-[0.3em] uppercase hover:text-stone-400 transition-colors",children:P("endingClickReturn",z)})})]})};var $=(m=>(m.INTRO="INTRO",m.INVENTORY="INVENTORY",m.RECORDER="RECORDER",m.NOTEBOOK="NOTEBOOK",m.FILM_SELECT="FILM_SELECT",m.FILM_VIEW="FILM_VIEW",m.ENDING="ENDING",m.FILM_LOOP="FILM_LOOP",m.TITLE_SCREEN="TITLE_SCREEN",m.SAVE_SELECT="SAVE_SELECT",m))($||{});const sy=()=>{const[m,A]=M.useState(()=>typeof window<"u"&&sessionStorage.getItem("the-missing-reel-skip-intro")?(sessionStorage.removeItem("the-missing-reel-skip-intro"),$.SAVE_SELECT):$.FILM_LOOP),[E,f]=M.useState(["log_auto"]),[z,C]=M.useState(["intro"]),[j,q]=M.useState([]),[I,x]=M.useState(!1),[U,R]=M.useState(null),[W,Le]=M.useState(!1),[Se,ze]=M.useState(!1),[Je,Me]=M.useState(!1),[ie,ee]=M.useState(!1),pe=M.useRef(null),xe=M.useRef(null),we=M.useRef(null),K=M.useRef(null),le=M.useRef(null),[_e,st]=M.useState(!1),[Ne,Be]=M.useState(!1),Oe=M.useRef(null),de=()=>{const u=to.loadGame();u&&(f(u.unlockedLogs),C(u.unlockedBlogs),q(u.unlockedReels),x(u.hasAutoPlayedRecorder),Be(u.hasEndingMusicFinished),console.log("[App] Game loaded from save"))};M.useEffect(()=>{de()},[]),M.useEffect(()=>{const u=setTimeout(()=>{to.saveGame({unlockedLogs:E,unlockedBlogs:z,unlockedReels:j,hasAutoPlayedRecorder:I,hasEndingMusicFinished:Ne})},300);return()=>clearTimeout(u)},[E,z,j,I,Ne]),M.useEffect(()=>{if(!pe.current){const u=new Audio(B("/assets/recorder_music.mp3"));u.loop=!0,u.volume=.7,pe.current=u}return()=>{pe.current&&(pe.current.pause(),pe.current=null)}},[]),M.useEffect(()=>{if(!we.current){const u=new Audio(B("/assets/film_music.mp3"));u.loop=!0,u.volume=.7,we.current=u}return()=>{we.current&&(we.current.pause(),we.current=null)}},[]),M.useEffect(()=>{if(!le.current){const u=new Audio(B("/assets/end_music.mp3"));u.loop=!1,u.volume=.7,u.addEventListener("ended",()=>{Be(!0),st(!1)}),le.current=u}return()=>{le.current&&(le.current.pause(),le.current=null)}},[]),M.useEffect(()=>{const u=pe.current;if(!u)return;const N=ie&&!W,O=_e&&!Ne;if(N){if(O){const L=le.current;if(L&&L.volume>0){Oe.current&&clearInterval(Oe.current);const V=L.volume;let J=0;Oe.current=setInterval(()=>{J++,L.volume=Math.max(0,V-V/20*J),J>=20&&(L.pause(),Oe.current&&(clearInterval(Oe.current),Oe.current=null))},50)}}u.volume=.7,u.play().catch(L=>console.warn("Recorder music play failed:",L))}else{xe.current&&clearInterval(xe.current);const L=u.volume,V=20,J=L/V;let se=0;xe.current=setInterval(()=>{se++;const T=Math.max(0,L-J*se);if(u.volume=T,(se>=V||T<=0)&&(u.pause(),xe.current&&(clearInterval(xe.current),xe.current=null),_e&&!Ne)){const X=le.current;if(X&&X.paused){X.volume=0,X.play().catch(Ie=>console.warn("Ending music resume failed:",Ie));let te=0;const re=setInterval(()=>{te++,X.volume=Math.min(.7,.7/20*te),te>=20&&clearInterval(re)},50)}}},50)}return()=>{xe.current&&clearInterval(xe.current)}},[ie,m,W,_e,Ne]),M.useEffect(()=>{const u=we.current;if(!u)return;const O=(m===$.FILM_SELECT||m===$.FILM_VIEW)&&!W,L=_e&&!Ne;if(O){if(L){const V=le.current;if(V&&V.volume>0){Oe.current&&clearInterval(Oe.current);const J=V.volume;let se=0;Oe.current=setInterval(()=>{se++,V.volume=Math.max(0,J-J/20*se),se>=20&&(V.pause(),Oe.current&&(clearInterval(Oe.current),Oe.current=null))},50)}}u.volume=.7,u.play().catch(V=>console.warn("Film music play failed:",V))}else{K.current&&clearInterval(K.current);const V=u.volume,J=20,se=V/J;let T=0;K.current=setInterval(()=>{T++;const X=Math.max(0,V-se*T);if(u.volume=X,(T>=J||X<=0)&&(u.pause(),K.current&&(clearInterval(K.current),K.current=null),_e&&!Ne)){const te=le.current;if(te&&te.paused){te.volume=0,te.play().catch(tt=>console.warn("Ending music resume failed:",tt));let re=0;const Ie=setInterval(()=>{re++,te.volume=Math.min(.7,.7/20*re),re>=20&&clearInterval(Ie)},50)}}},50)}return()=>{K.current&&clearInterval(K.current)}},[m,W,_e,Ne]),M.useEffect(()=>{m===$.ENDING&&!_e&&!Ne&&(console.log("Entering ENDING view, setting ending music to play"),st(!0))},[m,_e,Ne]),M.useEffect(()=>{const u=le.current;if(u){if(console.log("Ending music effect:",{isEndingMusicPlaying:_e,hasEndingMusicFinished:Ne,isMusicMuted:W,recorderMusicActive:ie,view:m}),W)u.paused||(console.log("Pausing ending music (muted)"),u.pause());else if(_e&&!Ne){const N=ie&&m===$.RECORDER,O=m===$.FILM_SELECT||m===$.FILM_VIEW;console.log("Ending music should play?",{isRecorderActive:N,isFilmActive:O}),!N&&!O?u.paused&&(console.log("Starting ending music playback"),u.volume=.7,u.play().catch(L=>console.warn("Ending music play failed:",L))):u.paused||(console.log("Pausing ending music (priority module active)"),u.pause())}}},[_e,Ne,W,ie,m]);let De=null;m===$.RECORDER?De=Lh.recorder:m===$.NOTEBOOK?De=null:m===$.FILM_SELECT||m===$.FILM_VIEW?De=Lh.film:(m===$.INVENTORY||m===$.INTRO||m===$.FILM_LOOP||m===$.ENDING)&&(De=null);const _=u=>{switch(u){case"recorder":A($.RECORDER);break;case"notebook":A($.NOTEBOOK);break;case"film":A($.FILM_SELECT);break}},D=u=>{E.includes(u)||f(N=>[...N,u])},G=u=>{z.includes(u)||C(N=>[...N,u])},oe=u=>{j.includes(u)||q(N=>[...N,u])},ye=()=>{st(!1),Be(!0);const u=le.current;u&&(u.pause(),u.currentTime=0)},d=()=>{console.log("[App] Resetting game state for new game"),localStorage.removeItem("the-missing-reel-tutorial-seen"),f(["log_auto"]),C(["intro"]),q([]),x(!1),Be(!1),R(null),A($.INTRO)};return o.jsx(Xp,{children:o.jsxs(Ep,{disableFilmEffects:m===$.NOTEBOOK&&(Je||Se),children:[o.jsx(ty,{currentTrack:De,isMuted:W,onToggleMute:()=>Le(!W),isEndingMusicPlaying:_e,onStopEndingMusic:ye}),m===$.FILM_LOOP&&o.jsx(ey,{onComplete:()=>A($.TITLE_SCREEN)}),m===$.TITLE_SCREEN&&o.jsx(ny,{onStart:()=>A($.SAVE_SELECT)}),m===$.SAVE_SELECT&&o.jsx(iy,{onNewGame:d,onContinue:()=>A($.INVENTORY)}),m===$.INTRO&&o.jsx(Pp,{onComplete:()=>A($.INVENTORY)}),m===$.INVENTORY&&o.jsx(Mp,{items:Qp,onSelectItem:_,unlockedLogs:E,unlockedBlogs:z,unlockedReels:j}),m===$.RECORDER&&o.jsx(Zp,{onBack:()=>{ee(!1),A($.INVENTORY)},unlockedLogs:E,onUnlockLog:D,hasAutoPlayed:I,setHasAutoPlayed:x,onTriggerEnding:()=>{ee(!1),A($.ENDING)},onMusicStart:()=>ee(!0)}),m===$.NOTEBOOK&&o.jsx(Kp,{onBack:()=>A($.INVENTORY),unlockedBlogs:z,onUnlockBlog:G,onViewChange:ze,isFlickerDisabled:Je,onToggleFlicker:()=>Me(u=>!u)}),m===$.FILM_SELECT&&o.jsx($p,{onBack:()=>A($.INVENTORY),onSelectReel:u=>{R(u),A($.FILM_VIEW)},unlockedReels:j,onUnlockReel:oe}),m===$.FILM_VIEW&&U&&(U.id==="reel_00"?o.jsx(Wp,{film:U,onBack:()=>A($.FILM_SELECT)}):o.jsx(Jp,{film:U,onBack:()=>A($.FILM_SELECT)})),m===$.ENDING&&o.jsx(oy,{onComplete:()=>A($.INVENTORY)})]})})},Zh=document.getElementById("root");if(!Zh)throw new Error("Could not find root element to mount to");const ry=Tp.createRoot(Zh);ry.render(o.jsx(_p.StrictMode,{children:o.jsx(sy,{})}));
